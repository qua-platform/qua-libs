...
with program() as readout_search:
    ...
    with stream_processing():
        ...
        I_on_st.buffer(len(qubit_IFs)).average().save("I_on")
        I_off_st.buffer(len(qubit_IFs)).average().save("I_off")
        (I_on_st - I_off_st).buffer(len(qubit_IFs)).average().save("I_diff")
        (I_on_st + I_off_st).buffer(len(qubit_IFs)).average().save("I_sum")
