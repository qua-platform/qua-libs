...
# Connect: "P1" to channel 1, "P2" to channel 2, "B1" to channel 3, "B1" to channel 4, "O5" to channel 5
arrangement = qdac.arrange(contacts={"P1": 1, "P2": 2, "B1": 3, "B2": 4, "O5": 5})
# Set initial voltage values
arrangement.set_virtual_voltages({"P1": 0.0, "P2": 0.0, "B1": 0.0, "B2": 0.0, "O5": 0.0})
sleep(0.5)
