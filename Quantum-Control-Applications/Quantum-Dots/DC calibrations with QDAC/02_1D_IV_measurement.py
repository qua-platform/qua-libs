...
arrangement = qdac.arrange(
        contacts={'p1': 4 , 'p2': 6, 'b1': 21}, # name the channels
        internal_triggers={'inner'}) # Internal trigger for measuring current
...
sweep = arrangement.virtual_sweep(
        ...
        step_trigger='inner') # choose the trigger for the measurement

# define the sensor parameters
sensor_channel = 5  # define sensing channel
sensor_integration_time = 15e-3  # define time [s] to integrate current over #NOTE: sensor_integration_time should be <= step_time
