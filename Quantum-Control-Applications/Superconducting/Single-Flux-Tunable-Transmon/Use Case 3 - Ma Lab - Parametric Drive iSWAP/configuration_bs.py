...
config = {
    ...
    "controllers": {
        "con1": {
            "type": "opx1",
            "analog_outputs": {
                1: {"offset": +0.0088},  # qubit I
                2: {"offset": +0.0027},  # qubit Q
                3: {"offset": -0.0366},  # Resonator I
                4: {"offset": +0.0044},  # Resonator Q
                5: {"offset": +0.0031},  # Fast Flux1, I
                6: {"offset": -0.0074},  # Fast Flux1, Q
            },
            "digital_outputs": {},
            "analog_inputs": {
...
pi_len_ef = 80 #80  # in units of ns
pi_amp_ef = 0.4  # in units of volts
pi_wf_ef = (pi_amp_ef * (gaussian(pi_len_ef, pi_len_ef / 5) -
                   gaussian(pi_len_ef, pi_len_ef / 5)[-1])).tolist()  # waveform

# Pi_half pulse parameters
pi_half_len_ef = 80 #80  # in units of ns
pi_half_amp_ef = 0.4 * 0.5  # in units of volts
pi_half_wf_ef = (pi_half_amp_ef * (gaussian(pi_half_len_ef, pi_half_len_ef / 5) -
                             gaussian(pi_half_len_ef, pi_half_len_ef / 5)[-1])).tolist()  # wavefo
...
<<<<<<< main
    "mixers": {
        "mixer_flux1": [
            {"intermediate_frequency": sideband, "lo_frequency": qubit_LO, "correction": IQ_imbalance(0.004, 0.088)},
        ],
        "mixer_qubit1": [
...
=======
    ...
    'mixers': {
        ...
        'mixer_qubit1ef': [
            {'intermediate_frequency': qubit1_if_ef, 'lo_frequency': qubit_LO, 'correction':  IQ_imbalance(0.006, 0.061)},
        ],
        ...
        'mixer_qubit2ef': [
            {'intermediate_frequency': qubit2_if_ef, 'lo_frequency': qubit_LO,
             'correction': IQ_imbalance(0.005,0.05)},
        ],

        'mixer_resonator1': [
            {'intermediate_frequency': resonator1_if, 'lo_frequency': resonator_LO, 'correction':  IQ_imbalance(0.006, 0.017)},
        ],
        'mixer_resonator2': [
            {'intermediate_frequency': resonator2_if, 'lo_frequency': resonator_LO, 'correction':  IQ_imbalance(0.006, 0.017)},
        ],
    }
>>>>>>> finish use case
}
