...
class Flux(object):
    ...
    def dc(self) -> List[Union[str, int, float, bool, list]]:
        ...
        if self._quam._record_updates:
            return _List(self._quam, self._path + "dc", self._index, self._schema)
    ...
    def fast_flux(self) -> List[Union[str, int, float, bool, list]]:
        ...
        if self._quam._record_updates:
            return _List(self._quam, self._path + "fast_flux", self._index, self._schema)
...
class Crosstalk(object):
    ...
    def rf(self) -> List[Union[str, int, float, bool, list]]:
        ...
        if self._quam._record_updates:
            return _List(self._quam, self._path + "rf", self._index, self._schema)
    ...
    def flux(self) -> Flux:
        """"""
        return Flux(self._quam, self._path + "flux.", self._index, self._schema["properties"]["flux"])
    ...
    def __init__(self, data: Union[None, str, dict] = None, flat_data=True):
        ...
        self._schema_flat = {
            ...
            "properties": {
                ...
                "qubits[].xy.T1": {"type": "array", "items": {"type": "number"}},
                "qubits[].xy.T2": {"type": "array", "items": {"type": "number"}},
                "qubits[].xy.wiring.I": {"type": "array", "items": {"type": "integer"}},
                "qubits[].xy.wiring.Q": {"type": "array", "items": {"type": "integer"}},
                "qubits[].xy.mixer_correction.offset_I": {"type": "array", "items": {"type": "number"}},
                "qubits[].xy.mixer_correction.offset_Q": {"type": "array", "items": {"type": "number"}},
                "qubits[].xy.mixer_correction.gain": {"type": "array", "items": {"type": "number"}},
                "qubits[].xy.mixer_correction.phase": {"type": "array", "items": {"type": "number"}},
                "qubits[].z.wiring": {"type": "array", "items": {"type": "integer"}},
                "qubits[].z.flux_pulse_length": {"type": "array", "items": {"type": "integer"}},
                "qubits[].z.flux_pulse_amp": {"type": "array", "items": {"type": "number"}},
                "qubits[].z.flux_zero_frequency": {"type": "array", "items": {"type": "number"}},
                ...
                "resonators[].wiring.I": {"type": "array", "items": {"type": "integer"}},
                "resonators[].wiring.Q": {"type": "array", "items": {"type": "integer"}},
                "resonators[].mixer_correction.offset_I": {"type": "array", "items": {"type": "number"}},
                "resonators[].mixer_correction.offset_Q": {"type": "array", "items": {"type": "number"}},
                "resonators[].mixer_correction.gain": {"type": "array", "items": {"type": "number"}},
                "resonators[].mixer_correction.phase": {"type": "array", "items": {"type": "number"}},
        ...
        self._schema = {
            ...
            "properties": {
                "network": {
                    "type": "object",
                    "title": "network",
                    "properties": {"qop_ip": {"type": "string"}, "qop_port": {"type": "integer"}},
                    "required": ["qop_ip", "qop_port"],
                },
                "local_oscillators": {
                    "type": "object",
                        ...
                        "properties": {
                            "xy": {
                                ...
                                "properties": {
                                    ...
                                    "wiring": {
                                        "type": "object",
                                        "title": "wiring",
                                        "properties": {"I": {"type": "integer"}, "Q": {"type": "integer"}},
                                        "required": ["I", "Q"],
                                    },
                                    "mixer_correction": {
                                        "type": "object",
                            ...
                            "z": {
                                ...
                                "properties": {
                                    ...
                                    "flux_zero_frequency": {"type": "number"},
                                },
                                "required": ["wiring", "flux_pulse_length", "flux_pulse_amp", "flux_zero_frequency"],
                            },
                        },
                        "required": ["xy", "z"],
                    },
