    ...
    config = {
        ...
        "controllers": {
            ...
            "con2": {
                "analog_outputs": {
                    ...
                    quam.qubits[2].z.wiring.port: {
                        "offset": quam.qubits[2].z.min_frequency_point,
                        "filter": {
                            "feedforward": quam.qubits[2].z.wiring.filter.fir_taps,
                            "feedback": quam.qubits[2].z.wiring.filter.iir_taps,
                        },
                    },
                    quam.qubits[3].z.wiring.port: {
                        "offset": quam.qubits[3].z.min_frequency_point,
                        "filter": {
        ...
        "elements": {
            ...
            **{
                f"{machine.qubits[i].name}_xy": {
                    ...
                    # },
                    "RF_inputs": {"port": ("octave1", quam.local_oscillators.qubits[quam.qubits[i].xy.LO_index].channel)},
                    "intermediate_frequency": (
        ...
        "octaves": {
            "octave1": {
                "RF_outputs": {
                    **{
                        quam.local_oscillators.qubits[quam.qubits[i].xy.LO_index].channel: {
                            "LO_frequency": quam.local_oscillators.qubits[quam.qubits[i].xy.LO_index].freq,
                            "LO_source": "internal",
                            "output_mode": "always_on",
                            "gain": quam.local_oscillators.qubits[quam.qubits[i].xy.LO_index].gain,
                        } for i in qubits_list
                    },
                    **{
                        quam.local_oscillators.readout[quam.resonators[i].LO_index].channel: {
                            "LO_frequency": quam.local_oscillators.readout[quam.resonators[i].LO_index].freq,
                            "LO_source": "internal",
                            "output_mode": "always_on",
                            "gain": quam.local_oscillators.readout[quam.resonators[i].LO_index].gain,
                        } for i in qubits_list
                    },
                },
                "RF_inputs": {
                    1: {
                        "LO_frequency": quam.local_oscillators.readout[quam.resonators[0].LO_index].freq,
                        "LO_source": "internal",
                    },
                },
                "connectivity": "custom",
