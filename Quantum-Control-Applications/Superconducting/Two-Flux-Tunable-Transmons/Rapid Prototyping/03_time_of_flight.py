...
with program() as raw_trace_prog:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        ...
        measure("readout", rr2.name, None)  # Also play the second readout tone to check the signal for multiplexing
        measure("readout", rr1.name, adc_st)
        # Wait for the resonator to deplete
        wait(rr1.depletion_time * u.ns, rr1.name, rr1.name)
...
if simulate:
    ...
    machine.global_parameters.downconversion_offset_I += -adc1_mean
    machine.global_parameters.downconversion_offset_Q += -adc1_mean
