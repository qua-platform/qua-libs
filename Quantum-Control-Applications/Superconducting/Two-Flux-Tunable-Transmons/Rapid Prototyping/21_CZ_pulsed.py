...
if simulate:
    ...
    while results.is_processing():
        ...
        plt.subplot(221)
        plt.cla()
        plt.pcolor(xplot, amps * machine.qubits[qubit_index].z.flux_pulse_amp + dc0_q1, I1)
        plt.title("q1 - I")
        plt.ylabel("Interaction time (ns)")
        plt.subplot(223)
        plt.cla()
        plt.pcolor(xplot, amps * machine.qubits[qubit_index].z.flux_pulse_amp + dc0_q1, Q1)
        plt.title("q1 - Q")
        plt.xlabel("FLux amplitude (V)")
        plt.ylabel("Interaction time (ns)")
        plt.subplot(222)
        plt.cla()
        plt.pcolor(xplot, amps * machine.qubits[qubit_index].z.flux_pulse_amp + dc0_q1, I2)
        plt.title("q2 - I")
        plt.subplot(224)
        plt.cla()
        plt.pcolor(xplot, amps * machine.qubits[qubit_index].z.flux_pulse_amp + dc0_q1, Q2)
        plt.title("q2 - Q")
        plt.xlabel("FLux amplitude (V)")
        plt.tight_layout()
        plt.pause(0.1)
