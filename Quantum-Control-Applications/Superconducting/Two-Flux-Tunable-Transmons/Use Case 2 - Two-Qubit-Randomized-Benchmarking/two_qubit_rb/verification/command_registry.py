...
def decorate_single_qubit_generator_with_command_recording(single_qubit_gate_generator: PhasedXZGeneratorFunc,
                                                           command_registry: CommandRegistry) -> PhasedXZGeneratorFunc:
    """
...
def decorate_two_qubit_gate_generator_with_command_recording(two_qubit_gate_generator: TwoQubitGateGenerator,
                                                             command_registry: CommandRegistry) -> TwoQubitGateGenerator:
    ...
    for gate_name, gate_generator in two_qubit_gate_generator.items():
        if gate_name == 'CZ':
            ...
            raise NotImplementedError(f"Command recording not implemented for {gate_name}. Please contact customer success.")
