...
from macros import qua_declaration, multiplexed_readout, plot_1qb_tomography_results, one_qb_QST
    ...
    with for_(n, 0, n < n_avg, n + 1):
        ...
        with for_(*from_array(a, amplitudes)):
            with for_(c, 0, c < 3, c + 1):
                # |0> control - CR
                play_flattop("cr_c1t2", a, "positive")
                align()
                play("x180", "q1_xy")
                align()
                play_flattop("cr_c1t2", a, "negative")
                align()
                play("x180", "q1_xy")
                align()
