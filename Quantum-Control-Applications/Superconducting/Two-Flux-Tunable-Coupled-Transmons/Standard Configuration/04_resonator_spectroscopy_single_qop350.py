...
if simulate:
    ...
    # Open a quantum machine to execute the QUA program and send the QUA program to the OPX, which compiles and executes it
    job = qm_wrapper(qmm,resonator_spec,controller_config,logical_config,full_config)
    ...
    while results.is_processing():
        # Fetch results
        I, Q, iteration = results.fetch_results(wait_until_done=True, timeout=60, stream_names=["I","Q","iteration"])
