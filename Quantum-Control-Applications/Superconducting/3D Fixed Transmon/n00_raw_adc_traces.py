...
resonator.readout_params.readout_length = 500e-09
resonator.readout_params.readout_amplitude = 0.4
...
with program() as raw_trace_prog:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        ...
        measure("readout", resonator.name, adc_st)
...
resonator.tof += 0
resonator.wiring_output.I.offset -= np.mean(adc1)
resonator.wiring_output.Q.offset -= np.mean(adc2)
