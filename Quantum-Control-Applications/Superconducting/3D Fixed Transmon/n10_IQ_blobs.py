...
resonator.readout_params.ge_threshold = threshold
resonator.readout_params.rotation_angle = angle
...
#
# # Active reset (faster):
# play("pi", qubit.name, condition=I > threshold)
#
#########################################
#
...
#     play("pi", qubit.name)
#     align(qubit.name, resonator.name)
#     measure("readout", resonator.name, None,
