...
number_of_divisions = int(resonator.readout_params.readout_length *1e9/ (4 * division_length))
...
if simulate:
    ...
    job = qmm.simulate(build_config(machine), opt_weights, simulation_config)
