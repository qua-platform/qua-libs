...
class Driving2(object):
    ...
    def square(self) -> Square2:
        """"""
        return Square2(self._quam, self._path + "square/", self._index, self._schema["properties"]["square"])
...
class Qubits_wo_charge(object):
    ...
    def driving(self) -> Driving2:
        """"""
        return Driving2(self._quam, self._path + "driving/", self._index, self._schema["properties"]["driving"])
...
class Qubits_wo_chargeList(object):
    ...
    def __getitem__(self, key) -> Qubits_wo_charge:
        return Qubits_wo_charge(self._quam, self._path + "[]/", self._index + [key], self._schema["items"])
...
class Qp_injector(object):
    ...
    def wiring(self) -> Wiring4:
        """"""
        return Wiring4(self._quam, self._path + "wiring/", self._index, self._schema["properties"]["wiring"])
...
class QuAM(object):
    def __init__(self, flat_json: Union[None, str, dict] = None):
        ...
        self._schema_flat = {
            ...
            "properties": {
                ...
                "qubits_wo_charge[]_len": {"anyof": [{"type": "array"}, {"type": "integer"}]},
            ...
            "properties": {
                ...
                "readout_lines": {
                    ...
                    "items": {
                        ...
                        "required": ["length", "lo_freq", "lo_power", "I_up", "Q_up", "I_down"],
                    },
                },
                "readout_resonators": {
                    "type": "array",
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "driving": {
                                ...
                                "required": ["drag_gaussian", "drag_cosine", "square"],
                            },
                            "wiring": {
                                "type": "object",
                                "title": "wiring",
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "wiring": {
                                ...
                                "required": ["drive_line_index", "correction_matrix", "maximum_amplitude"],
                            },
                        },
                        "required": [
                            "index",
    ...
    def qubits_wo_charge(self) -> Qubits_wo_chargeList:
        ...
        return Qubits_wo_chargeList(
            self._quam, self._path + "qubits_wo_charge", self._index, self._schema["properties"]["qubits_wo_charge"]
        )
