...
class QuAM(object):
    ...
    def two_qubit_gates(self, value: List[Union[str, int, float, bool, list]]):
        ...
        if (len(self._index) > 0):
            ...
            self._quam._json[self._path + "two_qubit_gates"] = value
