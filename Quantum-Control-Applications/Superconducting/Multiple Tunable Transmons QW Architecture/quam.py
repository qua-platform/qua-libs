...
class Flux_bias_pointsList(object):
    ...
    def __getitem__(self, key) -> Flux_bias_point:
        return Flux_bias_point(self._quam, self._path + "[]/", self._index + [key], self._schema["items"])
...
class Qubit(object):
    ...
    def flux_bias_points(self) -> Flux_bias_pointsList:
        ...
        return Flux_bias_pointsList(
            self._quam, self._path + "flux_bias_points", self._index, self._schema["properties"]["flux_bias_points"]
        )
...
class Flux_pulse(object):
    ...
    def constant(self) -> Constant2:
        """"""
        return Constant2(self._quam, self._path + "constant/", self._index, self._schema["properties"]["constant"])

    @property
    def arbitrary(self) -> Arbitrary2:
        """"""
        return Arbitrary2(self._quam, self._path + "arbitrary/", self._index, self._schema["properties"]["arbitrary"])
...
class CZ(object):
    ...
    def flux_pulse(self) -> Flux_pulse:
        """"""
        return Flux_pulse(self._quam, self._path + "flux_pulse/", self._index, self._schema["properties"]["flux_pulse"])
...
class CZList(object):
    ...
    def __getitem__(self, key) -> CZ:
        return CZ(self._quam, self._path + "[]/", self._index + [key], self._schema["items"])
...
class Two_qubit_gates(object):
    ...
    def CZ(self) -> CZList:
        """"""
        return CZList(self._quam, self._path + "CZ", self._index, self._schema["properties"]["CZ"])
...
class QuAM(object):
    def __init__(self, flat_json: Union[None, str, dict] = None):
        ...
        self._schema_flat = {
            ...
            "properties": {
                ...
                "qubits[]/flux_bias_points[]_len": {"anyof": [{"type": "array"}, {"type": "integer"}]},
                ...
                "two_qubit_gates/CZ[]_len": {"anyof": [{"type": "array"}, {"type": "integer"}]},
            },
                    ...
                    "properties": {
                        "CZ": {
                            ...
                            "items": {
                                ...
                                "title": "CZ",
                                "properties": {
                                    "conditional_qubit": {"type": "integer"},
                                    "target_qubit": {"type": "integer"},
                                    "flux_pulse": {
                                        "type": "object",
                                        "title": "flux_pulse",
                                        "properties": {
                                ...
                                "required": ["conditional_qubit", "target_qubit", "flux_pulse"],
                            },
                        }
                    },
                    "required": ["CZ"],
    ...
    def two_qubit_gates(self) -> Two_qubit_gates:
        ...
        return Two_qubit_gates(
            self._quam, self._path + "two_qubit_gates/", self._index, self._schema["properties"]["two_qubit_gates"]
        )
