...
max_circuit_depth = 2600  # Data memory limit is 16k and we need total vector size of 6*max_circuit_depth --> max_circuit_depth<=2600
...
def generate_sequence():
    ...
    with for_(i, 0, i < max_circuit_depth, i + 1):
        ...
        recovery_single, recovery_index_single = from_clifford_to_single(inv_gate[2*i], recovery_single, recovery_index_single)
