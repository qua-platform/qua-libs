...
config = {
    ...
    "elements": {
        ...
        "Pound_demod": {
            ...
            "operations": {"pound_demod_pulse": "pound_demod_pulse"},
            "digitalInputs": {
                "switch": {
                    "port": (controller, 3),
                    "delay": 144,
    ...
    "pulses": {
        ...
        "noise_CW": {"operation": "control", "length": 100, "waveforms": {"I": "const_wf", "Q": "zero_wf"}},
        "CW": {"operation": "control", "length": 100, "waveforms": {"I": "const_wf", "Q": "zero_wf"}},
        "saturation_pulse": {
            "operation": "control",
            "length": 20000,  # several T1s
            "waveforms": {"I": "saturation_wf", "Q": "zero_wf"},
        },
        "pi_pulse": {"operation": "control", "length": 60, "waveforms": {"I": "pi_wf", "Q": "zero_wf"}},
        "pi2_pulse": {"operation": "control", "length": 60, "waveforms": {"I": "pi2_wf", "Q": "zero_wf"}},
        "minus_pi2_pulse": {"operation": "control", "length": 60, "waveforms": {"I": "minus_pi2_wf", "Q": "zero_wf"}},
        "long_readout_pulse": {
            "operation": "measurement",
        ...
        "gauss_single_pulse": {
            ...
            "integration_weights": {"integ_gauss": "integ_gauss"},
            "digital_marker": "ON",
        },
        "gauss_pulse": {
            "operation": "measurement",
        ...
        "pound_pulse": {
            "operation": "measurement",
            "length": pound_pulse_length,
            "waveforms": {"I": "pound_I_wf", "Q": "pound_Q_wf"},
            "integration_weights": {
                "integW1": "integW1",
                "integW2": "integW2",
                "optW1": "optW1",
    ...
    "waveforms": {
        "simulated_pound_error_wf": {"type": "constant", "sample": 0.2},
        "const_wf": {"type": "constant", "sample": constant_amplitude},
        "zero_wf": {"type": "constant", "sample": 0.0},
        "saturation_wf": {"type": "constant", "sample": 0.211},
        "gauss_wf": {
            "type": "arbitrary",
            "samples": gauss(
                gauss_amplitude, 0.0, int(readout_len / 4), readout_len
            ),  # gauss(amplitude, mu, sigma, length):
        },
        "pound_I_wf": {"type": "arbitrary", "samples": pound_I_wf},
        "pound_Q_wf": {"type": "arbitrary", "samples": pound_Q_wf},
        "single_gauss_wf": {
            "type": "arbitrary",
        ...
        "long_readout_wf": {"type": "constant", "sample": constant_amplitude},
        "readout_wf": {"type": "constant", "sample": constant_amplitude},
    },
    "digital_waveforms": {"ON": {"samples": [(1, 0)]}},
    "integration_weights": {
        "pound_demod": {"cosine": pound_demod_cos, "sine": pound_demod_sin},
        "integ_gauss": {"cosine": [1.0] * int(single_gauss_len / 4), "sine": [0.0] * int(single_gauss_len / 4)},
        "long_integW1": {"cosine": [1.0] * int(long_redout_len / 4), "sine": [0.0] * int(long_redout_len / 4)},
        "long_integW2": {"cosine": [0.0] * int(long_redout_len / 4), "sine": [1.0] * int(long_redout_len / 4)},
        "integW1": {
        ...
        "optW1": {"cosine": [1.0] * int(readout_len / 4), "sine": [0.0] * int(readout_len / 4)},
        "optW2": {"cosine": [0.0] * int(readout_len / 4), "sine": [1.0] * int(readout_len / 4)},
        "integW1_cos": {
            "cosine": [1.0] * int(readout_len / 4),
            "sine": [0.0] * int(readout_len / 4),
        },
    ...
    "mixers": {
        "octave_octave1_1": [{"intermediate_frequency": rr_IF, "lo_frequency": rr_LO, "correction": [1, 0, 0, 1]}],
    },
}
