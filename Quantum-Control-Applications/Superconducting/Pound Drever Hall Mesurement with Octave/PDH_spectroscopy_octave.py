...
from qm.octave import calibration_db
...
qm.octave.set_downconversion(element, lo_source=RFInputLOSource.Internal) #Dmd2LO
...
with program() as PDH_spectroscopy2:
    with infinite_loop_():
        play('pound_pulse', 'RR')
...
with program() as PDH_spectroscopy:
    ...
    with for_(n, 0, n<N_averaging, n+1):
        ...
        with for_(f, f_init, f<f_final, f+df ):
            ...
            measure('pound_demod_pulse', 'Pound_demod', None, demod.full('integ_pound', pound_signal, 'out1')) #adc_st
