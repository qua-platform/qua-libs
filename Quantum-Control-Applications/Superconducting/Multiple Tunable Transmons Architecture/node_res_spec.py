...
nodeio.context(name="ResSpecNode", description="does resonator spec")

inputs = nodeio.Inputs()
inputs.stream("state", units="JSON", description="initial json generated by quam")
...
outputs.define("state", units="JSON", description="machine used in res spec")
...
while nodeio.status.active:
    ...
    print("Doing resonators spectroscopy...")
    ...
    if simulate:
        ...
        print("Resonators spectroscopy finished...")
        outputs.set(IQ=data)
