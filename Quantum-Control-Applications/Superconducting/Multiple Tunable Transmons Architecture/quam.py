...
class QuAM(object):
    ...
    def sideband(self) -> SidebandList:
        """"""
        return SidebandList(
            self._quam, self._path + "sideband", self._index,
            self._schema["properties"]["sideband"]
        )
