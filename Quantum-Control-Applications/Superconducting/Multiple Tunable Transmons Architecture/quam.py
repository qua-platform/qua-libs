...
class Analog_outputsList(object):
    ...
    def __getitem__(self, key) -> Analog_output:
        return Analog_output(self._quam, self._path + "[]/", self._index + [key], self._schema["items"])
...
class Analog_inputsList(object):
    ...
    def __getitem__(self, key) -> Analog_input:
        return Analog_input(self._quam, self._path + "[]/", self._index + [key], self._schema["items"])
...
class Analog_waveformsList(object):
    ...
    def __getitem__(self, key) -> Analog_waveform:
        return Analog_waveform(self._quam, self._path + "[]/", self._index + [key], self._schema["items"])
...
class Pulse(object):
    ...
    def waveforms(self) -> Waveforms:
        """"""
        return Waveforms(self._quam, self._path + "waveforms/", self._index, self._schema["properties"]["waveforms"])
...
class PulsesList(object):
    ...
    def __getitem__(self, key) -> Pulse:
        return Pulse(self._quam, self._path + "[]/", self._index + [key], self._schema["items"])
...
class Pulses_single(object):
    ...
    def waveforms(self) -> Waveforms2:
        """"""
        return Waveforms2(self._quam, self._path + "waveforms/", self._index, self._schema["properties"]["waveforms"])
...
class Pulses_singleList(object):
    ...
    def __getitem__(self, key) -> Pulses_single:
        return Pulses_single(self._quam, self._path + "[]/", self._index + [key], self._schema["items"])
...
class Wiring(object):
    ...
    def correction_matrix(self) -> List[Union[str, int, float, bool, list]]:
        ...
        if self._quam._record_updates:
            return _List(self._quam, self._path + "correction_matrix", self._index, self._schema)
...
class Wiring2(object):
    ...
    def flux_line(self) -> List[Union[str, int, float, bool, list]]:
        ...
        if self._quam._record_updates:
            return _List(self._quam, self._path + "flux_line", self._index, self._schema)
...
class Sideband(object):
    ...
    def IF(self) -> float:
        ...
        value = self._quam._json[self._path + "IF"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value

    @IF.setter
    def IF(self, value: float):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "IF")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if len(self._index) > 0:
            value_ref = self._quam._json[self._path + "IF"]
            for i in range(len(self._index) - 1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "IF"] = value

    @property
    def sideband_amplitude(self) -> float:
        """"""

        value = self._quam._json[self._path + "sideband_amplitude"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value

    @sideband_amplitude.setter
    def sideband_amplitude(self, value: float):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "sideband_amplitude")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if len(self._index) > 0:
            value_ref = self._quam._json[self._path + "sideband_amplitude"]
            for i in range(len(self._index) - 1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "sideband_amplitude"] = value
...
class SidebandList(object):
    ...
    def __getitem__(self, key) -> Sideband:
        return Sideband(self._quam, self._path + "[]/", self._index + [key], self._schema["items"])
    ...
    def append(self, json_item: dict):
        """Adds a new sideband by adding a JSON dictionary with following schema
        {
          "f_res": {
            "type": "number"
          },
...
class QuAM(object):
    def __init__(self, flat_json: Union[None, str, dict] = None):
        ...
        self._schema_flat = {
            ...
            "type": "object",
            "properties": {
                "analog_outputs[]_len": {"anyof": [{"type": "array"}, {"type": "integer"}]},
                "analog_inputs[]_len": {"anyof": [{"type": "array"}, {"type": "integer"}]},
                "analog_waveforms[]_len": {"anyof": [{"type": "array"}, {"type": "integer"}]},
                "digital_waveforms[]_len": {"anyof": [{"type": "array"}, {"type": "integer"}]},
                "pulses[]_len": {"anyof": [{"type": "array"}, {"type": "integer"}]},
                "pulses_single[]_len": {"anyof": [{"type": "array"}, {"type": "integer"}]},
                "readout_lines[]_len": {"anyof": [{"type": "array"}, {"type": "integer"}]},
                "readout_resonators[]_len": {"anyof": [{"type": "array"}, {"type": "integer"}]},
                "drive_line[]_len": {"anyof": [{"type": "array"}, {"type": "integer"}]},
                ...
                "sideband[]_len": {"anyof": [{"type": "array"}, {"type": "integer"}]},
            },
            ...
            "properties": {
                "analog_outputs": {
                    ...
                    "items": {
                        ...
                        "required": ["controller", "output", "offset"],
                    },
                },
                "analog_inputs": {
                    "type": "array",
                    "items": {
                        ...
                        "required": ["controller", "input", "offset", "gain_db"],
                    },
                },
                "analog_waveforms": {
                    "type": "array",
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "waveforms": {
                                "type": "object",
                                "title": "waveforms",
                                "properties": {"I": {"type": "string"}, "Q": {"type": "string"}},
                                "required": ["I", "Q"],
                            },
                        },
                        "required": ["name", "operation", "length", "waveforms"],
                    },
                },
                "pulses_single": {
                    "type": "array",
                ...
                "readout_lines": {
                    ...
                    "items": {
                        ...
                        "title": "readout_line",
                        "properties": {
                            "length": {"type": "number", "description": "readout time (seconds) on this drive line"},
                            "lo_freq": {"type": "number", "description": "LO frequency for readout line"},
                        },
                        "required": ["length", "lo_freq"],
                    },
                },
                "readout_resonators": {
                    "type": "array",
                    "items": {
                        ...
                        "properties": {
                            ...
                            "wiring": {
                                ...
                                "title": "wiring",
                                "properties": {
                                    "readout_line_index": {"type": "integer"},
                                ...
                                "required": ["readout_line_index", "time_of_flight", "I", "Q", "correction_matrix"],
                            },
                        },
                        "required": [
                            "f_res",
                ...
                "crosstalk_matrix": {
                    ...
                    "properties": {
                        "static": {
                            ...
                            "description": "crosstalk matrix for slow flux lines",
                        },
                        "fast": {
                            "type": "array",
                            "items": {
                            ...
                            "description": "crosstalk matrix for fast flux lines",
                        },
                    },
                ...
                "drive_line": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "freq": {"type": "number", "description": "LO frequency"},
                            "power": {"type": "integer", "description": "LO power to mixer"},
                        },
                        "required": ["qubits", "freq", "power"],
                    },
                },
                "qubits": {
                    "type": "array",
                    "items": {
                        ...
                        "title": "qubit",
                        "properties": {
                            "f_01": {"type": "number", "description": "01 transition frequency (Hz)"},
                            "anharmonicity": {"type": "number"},
                            "rabi_freq": {"type": "number"},
                            "t1": {"type": "number"},
                            "t2": {"type": "number"},
                            "t2star": {"type": "number"},
                            "driving": {
                                ...
                                "title": "driving",
                                "properties": {
                                    "gate_len": {"type": "number", "description": "(seconds)"},
                                    "gate_sigma": {"type": "number"},
                                    "gate_shape": {"type": "string"},
                                    "angle2volt": {
                                        "type": "object",
                                        "title": "angle2volt",
                                ...
                                "required": ["gate_len", "gate_sigma", "gate_shape", "angle2volt"],
                            },
                            "wiring": {
                                "type": "object",
                                "title": "wiring",
                                ...
                                "required": ["I", "Q", "correction_matrix", "flux_line", "flux_filter_coef"],
                            },
                            "sequence_states": {
                                "type": "array",
                                "items": {
                ...
                "sideband": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "LO": {"type": "number"},
                            "IF": {"type": "number"},
                            "sideband_amplitude": {"type": "number"},
                            "wiring": {
                                "type": "object",
                                "title": "wiring",
                                "properties": {
                                ...
                                "required": ["I", "Q", "correction_matrix"],
                            },
                        },
                        "required": ["f_res", "LO", "IF", "sideband_amplitude", "wiring"],
                    },
                },
            },
            "required": [
    ...
    def analog_outputs(self) -> Analog_outputsList:
        ...
        return Analog_outputsList(
            self._quam, self._path + "analog_outputs", self._index, self._schema["properties"]["analog_outputs"]
        )
    ...
    def analog_inputs(self) -> Analog_inputsList:
        ...
        return Analog_inputsList(
            self._quam, self._path + "analog_inputs", self._index, self._schema["properties"]["analog_inputs"]
        )
    ...
    def analog_waveforms(self) -> Analog_waveformsList:
        ...
        return Analog_waveformsList(
            self._quam, self._path + "analog_waveforms", self._index, self._schema["properties"]["analog_waveforms"]
        )
    ...
    def pulses(self) -> PulsesList:
        """"""
        return PulsesList(self._quam, self._path + "pulses", self._index, self._schema["properties"]["pulses"])

    @property
    def pulses_single(self) -> Pulses_singleList:
        """"""
        return Pulses_singleList(
            self._quam, self._path + "pulses_single", self._index, self._schema["properties"]["pulses_single"]
        )
    ...
    def drive_line(self) -> Drive_lineList:
        ...
        return Drive_lineList(
            self._quam, self._path + "drive_line", self._index, self._schema["properties"]["drive_line"]
        )
    ...
    @property
    def sideband(self) -> SidebandList:
        """"""
        return SidebandList(self._quam, self._path + "sideband", self._index, self._schema["properties"]["sideband"])
