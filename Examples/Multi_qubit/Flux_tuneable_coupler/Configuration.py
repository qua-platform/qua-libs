...
config = {
    ...
    'mixers': {
        ...
        'mixer_RO': [
            {'intermediate_frequency': RR_1_IF, 'lo_frequency': RO_lo, 'correction': [1, 0, 0, 1]},
            {'intermediate_frequency': RR_2_IF, 'lo_frequency': RO_lo, 'correction': [1, 0, 0, 1]},
        ],

        'mixer_XY': [
            {'intermediate_frequency': Q1_XY_IF, 'lo_frequency': XY_lo, 'correction': [1, 0, 0, 1]},
            {'intermediate_frequency': Q2_XY_IF, 'lo_frequency': XY_lo, 'correction': [1, 0, 0, 1]}
        ],
