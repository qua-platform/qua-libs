...
Use the **quick links** below to jump to each section. The **CZ** part is fully written (based on the Mitchell *et al.* paper and our slides). The **CR** and **MW‑crosstalk** parts are **placeholders** for now—owners noted per our task split.

### Quick Links

* 👉 **[CR Gate (Cross Resonance)](#cr-gate-cross-resonance)** — *placeholder; owner **Soon** (nodes {30–31g}).*
* 👉 **[Stark‑Induced CZ Gate (Microwave‑Activated Tunable ZZ)](#stark-induced-cz-gate-microwave-activated-tunable-zz)** — **complete** section with concept, tuning, and QUA nodes.
...
> **Source material used in the CZ section**
> Paper: “Hardware‑Efficient Microwave‑Activated Tunable Coupling Between Superconducting Qubits.”&#x20;
> Slides: “CZ Gate Implementation” (compact figures/code callouts).&#x20;

---

## CR Gate (Cross Resonance)

> ***Placeholder — Soon** to add content for nodes {30–31g} (code review + README section).*

**To be included by owner:**

* Brief CR concept & matrix / effective Hamiltonian.
* Abstract vs experimental realization (drive, echo, cancellation terms).
* QUAlibrate/QUA notes: focus on `create_qua_program` and `analyse_data`.
* Image placeholders (pulse sequence, analysis panels).
...
> **Paper basis** – Bradley K. Mitchell *et al.*, “Hardware‑Efficient Microwave‑Activated Tunable Coupling Between Superconducting Qubits,” 2021. We cite it throughout and point to specific figures for visuals you can place in this README.&#x20;
> **Slides** – “CZ Gate Implementation” deck with compact figures used for annotation and code highlights.&#x20;
...
> **Place figure here**
> 📎 *Slides p.2–3*: “CZ gate representation” and “Decomposition of CZ gate” (matrix and Pauli terms).&#x20;
...
> **Place figure here**
> 📎 *Paper Fig. 1 (p.2)*: “Drive scheme for the Stark‑induced ZZ interaction” (levels, detuning \$\Delta=\omega\_c-\omega\_t\$, simultaneous drives \$\epsilon\_c,\epsilon\_t\$).&#x20;
...
We explain only **two functions** as requested.
