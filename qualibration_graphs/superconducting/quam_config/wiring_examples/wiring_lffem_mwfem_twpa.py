...
# The TWPA pumps
connectivity.add_twpa_lines(twpas=["A"], pump_constraints=mw_fem_spec(out_port=4))
# connectivity.add_twpa_lines(twpas=["A"], pump_constraints=mw_fem_spec(out_port=4), isolation_constraints=mw_fem_spec(out_port=6))
# The xy drive lines
