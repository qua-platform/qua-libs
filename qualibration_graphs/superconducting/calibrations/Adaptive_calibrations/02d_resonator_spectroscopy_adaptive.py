...
from calibration_utils.resonator_spectroscopy_adaptive import (
    Parameters,
    process_raw_dataset,
    fit_raw_data,
    log_fitted_results,
...
# # Override Parameters for adaptive resonator spec only
# class Resonator_Parameters(Parameters):
...
node = QualibrationNode[Parameters, Quam](
    name="02d_resonator_spectroscopy_adaptive",  # Name should be unique
