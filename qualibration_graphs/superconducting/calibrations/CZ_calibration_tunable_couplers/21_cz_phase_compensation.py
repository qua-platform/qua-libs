...
node = QualibrationNode[Parameters, Quam](
    name="cz_phase_compensation",  # Name should be unique
            ...
            with for_(n, 0, n < n_avg, n + 1):
                ...
                with for_(*from_array(frame, frames)):
                    for ii, qp in multiplexed_qubit_pairs.items():
                        ...
                        assign(extra_phase_c, qp.macros["cz"].phase_shift_control)
                        assign(extra_phase_t, qp.macros["cz"].phase_shift_target)
                        ...
                        for qubit, state_q, state_st in [
                            ...
                            if qubit is qp.qubit_control:
                                qp.macros["cz"].apply(phase_shift_control=frame + extra_phase_c)
                                qp.align()
                            elif qubit is qp.qubit_target:
                                qp.macros["cz"].apply(phase_shift_target=frame + extra_phase_t)
                                qp.align()
