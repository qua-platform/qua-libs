...
from quam_libs.lib.fit import fit_oscillation, fix_oscillation_phi_2pi, oscillation
...
if not node.parameters.simulate:
    ...
    for qp in qubit_pairs:
        ...
        print(
            f"parameters for {qp.name}: amp={optimal_amps[qp.name]}, old amp={qp.gates['Cz'].flux_pulse_control.amplitude}"
        )
