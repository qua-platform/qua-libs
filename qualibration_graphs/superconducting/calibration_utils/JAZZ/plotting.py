...
def plot_raw_data_with_fit(
    ...
    for i, qp in enumerate(qubit_pairs):
        ...
        data_g = fit_results.g_state_control.sel(qubit_pair=qp_name).mean(dim="frame")
        data_e = fit_results.e_state_control.sel(qubit_pair=qp_name).mean(dim="frame")
        data_f = fit_results.f_state_control.sel(qubit_pair=qp_name).mean(dim="frame")
