...
def _extract_relevant_fit_parameters(fit: xr.Dataset) -> Tuple[xr.Dataset, Dict[str, FitParameters]]:
    """
    ...
    fitted_frequency = fit.fit.sel(fit_vals="f")
    ...
    decay = fit.fit.sel(fit_vals="decay")
