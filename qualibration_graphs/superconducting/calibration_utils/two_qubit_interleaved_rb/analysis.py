...
def process_raw_dataset(ds: xr.Dataset, node: QualibrationNode):
    ...
    rename_map = {"shots": "average", "sequence": "repeat", "depths": "circuit_depth"}
    rename_map = {k: v for k, v in rename_map.items() if k in ds.dims}
