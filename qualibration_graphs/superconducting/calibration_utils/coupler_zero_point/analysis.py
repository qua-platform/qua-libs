"""Analysis functions for coupler zero-point calibration.

This module provides functions for processing raw data and fitting results
for coupler zero-point calibration experiments.
"""
