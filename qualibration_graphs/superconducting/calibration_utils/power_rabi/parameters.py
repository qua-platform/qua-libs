...
class EfNodeSpecificParameters(BasePowerRabiParameters):
    """12b EF-specific parameters (single EF pi pulse; no error amplification)."""

    operation: Literal["EF_x180"] = "EF_x180"
    """Operation used for shared analysis logic. Always EF_x180 for this node."""
