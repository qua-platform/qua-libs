...
from examples.two_qubit_rb import prep
...
from calibration_utils.iq_utils import plot_rotated_iq_density_at_optimum
...
def plot_data(node: QualibrationNode[Parameters, Quam]):
    ...
    figs = plot_ramp_duration_sweep_figures(node, sweep_name=sweep_name)
