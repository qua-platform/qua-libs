...
g = QualibrationGraph(
    ...
    nodes={
        "sensor_dot_tuning": library.nodes["00_sensor_dot_tuning"].copy(
            name="sensor_dot_tuning"
        ),
        "sensor_gate_compensation": library.nodes["01_sensor_gate_compensation"].copy(
            name="sensor_gate_compensation"
        ),
        ...
        "barrier_compensation": library.nodes["03_barrier_compensation"].copy(
            name="barrier_compensation"
        ),
    },
    connectivity=[
