...
g = QualibrationGraph(
    name="ResetInitGateOptimization",
    parameters=Parameters(),
    nodes={
        "optimize_reset_initialize": library.nodes["02a_optimize_reset_initialize"].copy(
            name="optimize_reset_initialize"
        ),
    ...
    connectivity=[
        ("optimize_reset_initialize", "cmaes_gate_optimization"),
    ],
