...
![Snapshot102 Heatmap](snapshot102_heatmap.png)
![Snapshot102 Resonance](snapshot102_resonance.png)
...
| Parameter | Value |
|-----------|-------|
| `opt_amp` | `0.8802102959050874` |
| `rabi_frequency` | `287.4124113137459` |
| `decay_rate` | `0.026900405152361927` |
| `gauss_decay_rate` | `0.008030225874026091` |
| `n_eff` | `34.34630829721571` |
| `success` | `True` |
...
|-----------|--------|-------|
| `qubits.q1.xy.operations.gaussian_x180.amplitude` | `0.25` | `0.09684627062716518` |
| `qubits.q1.xy.operations.gaussian_x90.amplitude` | `0.125` | `0.04842313531358259` |
...
| Key | Value |
|-----|-------|
| Timestamp | 2026-08-28T13:57:50 UTC |
