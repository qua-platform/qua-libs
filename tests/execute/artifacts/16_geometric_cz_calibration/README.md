...
| `max_exchange_duration_in_ns` | `500` | Maximum exchange pulse duration in nanoseconds. Default is 2000 ns. |
| `duration_step_in_ns` | `20` | Step size for the exchange pulse duration sweep in nanoseconds. Default is 20 ns. |
| `min_exchange_amplitude` | `0.0` | Minimum exchange pulse amplitude (virtual barrier gate voltage, V). Default is 0.0. |
...
| `J_at_operating_point` | `0.0` |
| `t_pi_cphase` | `[nan, nan, nan, nan, nan, nan, nan, nan, nan, nan]` |
| `t_2pi_swap` | `[nan, nan, nan, nan, nan, nan, nan, nan, nan, nan]` |
| `success` | `False` |
...
| Key | Value |
|-----|-------|
| Timestamp | 2026-04-29T00:50:06 UTC |
| Node | 16_geometric_cz_calibration |
| Duration | 48.3s |
| Status | completed |
