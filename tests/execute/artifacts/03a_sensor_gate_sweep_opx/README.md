...
| `num_shots` | `2` | Number of averages to perform. Default is 100. |
| `offset_min` | `-0.1` | Minimum voltage offset for the sensor gate sweep in volts. Default is -0.2 V. |
| `offset_max` | `0.1` | Maximum voltage offset for the sensor gate sweep in volts. Default is 0.2 V. |
| `offset_step` | `0.1` | Step size for the voltage offset sweep in volts. Default is 0.005 V. |
...
![Snapshot24 Phase](snapshot24_phase.png)
![Snapshot24 Amplitude Gradient](snapshot24_amplitude_gradient.png)
...
| `peak_width` | `nan` |
| `lorentzian_x0` | `nan` |
| `lorentzian_gamma` | `nan` |
| `lorentzian_amplitude` | `nan` |
| `lorentzian_offset` | `nan` |
| `optimal_bias` | `nan` |
| `max_gradient` | `nan` |
| `max_gradient_bias` | `nan` |
| `success` | `False` |
...
| Key | Value |
|-----|-------|
| Timestamp | 2026-08-18T12:42:37 UTC |
| Node | 03a_sensor_gate_sweep_opx |
| Duration | 4.6s |
| Status | completed |
