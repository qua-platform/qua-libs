...
![Snapshot98 Rabi](snapshot98_rabi.png)
![Snapshot98 Fft](snapshot98_fft.png)
...
| Parameter | Value |
|-----------|-------|
| `opt_amp` | `0.047477611875823965` |
| `rabi_frequency` | `66.16998053327785` |
| `decay_rate` | `0.6428717467147282` |
| `success` | `True` |
...
|-----------|--------|-------|
| `qubits.q1.xy.operations.gaussian_x180.amplitude` | `0.25` | `0.0002817654536789226` |
| `qubits.q1.xy.operations.gaussian_x90.amplitude` | `0.125` | `0.0001408827268394613` |
...
| Key | Value |
|-----|-------|
| Timestamp | 2026-08-28T13:51:18 UTC |
| Node | 09a_power_rabi |
| Duration | 4.4s |
| Status | completed |
