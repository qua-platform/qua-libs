...
| Key | Value |
|-----|-------|
| Timestamp | 2026-04-17T01:55:43 UTC |
| Node | 14a_crot_spectroscopy_parity_diff |
| Duration | 60.5s |
| Status | completed with errors |
| Error | `QmServerDetectionError: Failed to detect to QuantumMachines server, failed to connect to cluster 'CS_4'. Tried connecting to 172.16.33.114:80.` |
