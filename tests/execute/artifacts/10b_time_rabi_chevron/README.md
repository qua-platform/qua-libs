...
| `frequency_span_in_mhz` | `40.0` | Span of frequencies to sweep in MHz. Default is 5 MHz. |
| `frequency_step_in_mhz` | `5.0` | Step size for the frequency detuning sweep in MHz. Default is 0.05 MHz. |
...
![Snapshot98 Chevron](snapshot98_chevron.png)
![Snapshot98 Fft 2D](snapshot98_fft_2d.png)
![Snapshot98 Diagnostics](snapshot98_diagnostics.png)
...
| Key | Value |
|-----|-------|
| Timestamp | 2026-08-28T13:52:22 UTC |
