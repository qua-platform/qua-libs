"""Simulation test for 16a_geometric_cz_duration_calibration."""
...
def test_geometric_cz_duration_calibration_simulation(simulation_runner):
    """Compile and simulate the fixed-amplitude geometric CZ duration program."""
