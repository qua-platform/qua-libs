...
| `model_fields_set` | `{'gap_wait_time_in_ns', 'simulation_duration_ns', 'tau_max', 'use_state_discrimination', 'num_shots', 'use_waveform_report', 'qubits', 'multiplexed', 'operation', 'load_data_id', 'reset_wait_time', 'tau_step', 'timeout', 'tau_min', 'simulate'}` |  |
