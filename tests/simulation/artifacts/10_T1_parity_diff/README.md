...
| `model_fields_set` | `{'use_state_discrimination', 'tau_min', 'simulate', 'qubits', 'operation', 'gap_wait_time_in_ns', 'tau_step', 'num_shots', 'multiplexed', 'reset_wait_time', 'use_waveform_report', 'timeout', 'load_data_id', 'tau_max', 'simulation_duration_ns'}` |  |
