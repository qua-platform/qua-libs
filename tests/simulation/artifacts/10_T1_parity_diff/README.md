...
| `model_fields_set` | `{'use_state_discrimination', 'multiplexed', 'timeout', 'reset_wait_time', 'num_shots', 'simulate', 'simulation_duration_ns', 'tau_max', 'operation', 'tau_step', 'qubits', 'load_data_id', 'tau_min', 'use_waveform_report'}` |  |
