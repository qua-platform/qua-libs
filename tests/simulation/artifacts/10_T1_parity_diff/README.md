...
| `model_fields_set` | `{'multiplexed', 'tau_max', 'tau_step', 'operation', 'use_state_discrimination', 'load_data_id', 'simulation_duration_ns', 'tau_min', 'simulate', 'qubits', 'reset_wait_time', 'sensor_names', 'timeout', 'gap_wait_time_in_ns', 'num_shots', 'use_waveform_report'}` |  |
...
| `tau_step` | `16` | Step size for the pulse duration sweep in nanoseconds. Default is 16 ns. |
