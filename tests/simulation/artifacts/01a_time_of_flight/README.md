...
| `model_fields_set` | `{'readout_amplitude_in_v', 'multiplexed', 'time_of_flight_in_ns', 'num_shots', 'readout_length_in_ns', 'simulate', 'simulation_duration_ns', 'use_state_discrimination', 'use_waveform_report', 'load_data_id', 'reset_wait_time', 'sensor_names', 'timeout'}` |  |
