...
| `model_fields_set` | `{'sensor_names', 'time_of_flight_in_ns', 'reset_wait_time', 'multiplexed', 'simulate', 'simulation_duration_ns', 'num_shots', 'readout_amplitude_in_v', 'load_data_id', 'use_waveform_report', 'readout_length_in_ns', 'use_state_discrimination', 'timeout'}` |  |
