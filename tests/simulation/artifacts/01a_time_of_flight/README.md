...
| `model_fields_set` | `{'simulation_duration_ns', 'use_state_discrimination', 'readout_amplitude_in_v', 'num_shots', 'time_of_flight_in_ns', 'use_waveform_report', 'sensor_names', 'multiplexed', 'load_data_id', 'reset_wait_time', 'timeout', 'simulate', 'readout_length_in_ns'}` |  |
