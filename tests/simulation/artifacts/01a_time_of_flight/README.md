...
| `model_fields_set` | `{'use_waveform_report', 'simulate', 'time_of_flight_in_ns', 'multiplexed', 'readout_amplitude_in_v', 'sensor_names', 'simulation_duration_ns', 'load_data_id', 'num_shots', 'readout_length_in_ns', 'reset_wait_time', 'timeout', 'use_state_discrimination'}` |  |
