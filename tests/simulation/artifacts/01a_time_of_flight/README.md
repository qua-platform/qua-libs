...
| `model_fields_set` | `{'multiplexed', 'num_shots', 'readout_length_in_ns', 'sensor_names', 'time_of_flight_in_ns', 'use_waveform_report', 'use_state_discrimination', 'timeout', 'readout_amplitude_in_v', 'reset_wait_time', 'simulate', 'load_data_id', 'simulation_duration_ns'}` |  |
