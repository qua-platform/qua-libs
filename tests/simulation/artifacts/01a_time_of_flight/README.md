...
| `model_fields_set` | `{'use_waveform_report', 'time_of_flight_in_ns', 'load_data_id', 'multiplexed', 'readout_length_in_ns', 'sensor_names', 'timeout', 'num_shots', 'use_state_discrimination', 'simulation_duration_ns', 'reset_wait_time', 'readout_amplitude_in_v', 'simulate'}` |  |
