...
| `model_fields_set` | `{'multiplexed', 'reset_wait_time', 'simulate', 'time_of_flight_in_ns', 'use_waveform_report', 'readout_length_in_ns', 'readout_amplitude_in_v', 'num_shots', 'sensor_names', 'use_state_discrimination', 'load_data_id', 'timeout', 'simulation_duration_ns'}` |  |
