...
| `model_fields_set` | `{'timeout', 'use_waveform_report', 'device_gate_span', 'video_mode_port', 'device_gate_points', 'simulation_duration_ns', 'simulate', 'sensor_gate_points', 'scan_pattern', 'per_line_compensation', 'sensor_gate_span', 'load_data_id', 'device_gate_from_qdac', 'dc_control', 'post_trigger_wait_ns', 'run_in_video_mode', 'virtual_gate_set_id', 'num_shots', 'sensor_names', 'pre_measurement_delay', 'sensor_device_mapping', 'sensor_gate_from_qdac', 'ramp_duration', 'hold_duration'}` |  |
