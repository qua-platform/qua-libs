...
| `model_fields_set` | `{'video_mode_port', 'timeout', 'result_type', 'device_gate_span', 'device_gate_from_qdac', 'per_line_compensation', 'sensor_names', 'ramp_duration', 'simulate', 'simulation_duration_ns', 'pre_measurement_delay', 'sensor_gate_span', 'use_waveform_report', 'device_gate_points', 'dc_control', 'post_trigger_wait_ns', 'virtual_gate_set_id', 'num_shots', 'load_data_id', 'run_in_video_mode', 'sensor_gate_from_qdac', 'scan_pattern', 'hold_duration', 'sensor_gate_points', 'sensor_device_mapping'}` |  |
