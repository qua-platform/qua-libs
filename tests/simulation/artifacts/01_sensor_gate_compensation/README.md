...
| `model_fields_set` | `{'sensor_names', 'hold_duration', 'simulate', 'sensor_gate_span', 'run_in_video_mode', 'device_gate_from_qdac', 'timeout', 'sensor_gate_from_qdac', 'pre_measurement_delay', 'device_gate_points', 'sensor_gate_points', 'device_gate_span', 'simulation_duration_ns', 'dc_control', 'virtual_gate_set_id', 'result_type', 'num_shots', 'sensor_device_mapping', 'video_mode_port', 'use_waveform_report', 'load_data_id', 'ramp_duration', 'per_line_compensation', 'scan_pattern', 'post_trigger_wait_ns'}` |  |
