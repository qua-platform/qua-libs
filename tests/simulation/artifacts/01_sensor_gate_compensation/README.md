...
| `model_fields_set` | `{'timeout', 'run_in_video_mode', 'sensor_gate_from_qdac', 'simulate', 'sensor_device_mapping', 'num_shots', 'device_gate_span', 'device_gate_points', 'sensor_gate_span', 'load_data_id', 'pre_measurement_delay', 'sensor_names', 'scan_pattern', 'dc_control', 'sensor_gate_points', 'virtual_gate_set_id', 'video_mode_port', 'hold_duration', 'ramp_duration', 'post_trigger_wait_ns', 'per_line_compensation', 'simulation_duration_ns', 'device_gate_from_qdac', 'use_waveform_report'}` |  |
