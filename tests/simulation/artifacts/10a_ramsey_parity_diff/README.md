...
| `model_fields_set` | `{'use_waveform_report', 'frequency_detuning_in_mhz', 'num_shots', 'log_or_linear_sweep', 'simulation_duration_ns', 'min_wait_time_in_ns', 'reset_type', 'wait_time_num_points', 'qubits', 'max_wait_time_in_ns', 'timeout', 'use_state_discrimination', 'load_data_id', 'simulate', 'multiplexed'}` |  |
