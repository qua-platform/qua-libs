...
| `model_fields_set` | `{'simulation_duration_ns', 'use_waveform_report', 'gap_wait_time_in_ns', 'frequency_detuning_in_mhz', 'max_wait_time_in_ns', 'timeout', 'min_wait_time_in_ns', 'log_or_linear_sweep', 'wait_time_num_points', 'qubits', 'simulate', 'load_data_id', 'num_shots', 'multiplexed', 'use_state_discrimination', 'reset_type'}` |  |
