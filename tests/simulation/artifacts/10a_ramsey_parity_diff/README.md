...
| `model_fields_set` | `{'use_waveform_report', 'wait_time_num_points', 'load_data_id', 'qubits', 'multiplexed', 'min_wait_time_in_ns', 'reset_type', 'frequency_detuning_in_mhz', 'num_shots', 'use_state_discrimination', 'log_or_linear_sweep', 'simulation_duration_ns', 'max_wait_time_in_ns', 'timeout', 'simulate'}` |  |
