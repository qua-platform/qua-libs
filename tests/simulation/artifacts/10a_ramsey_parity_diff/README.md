...
| `model_fields_set` | `{'gap_wait_time_in_ns', 'reset_type', 'simulation_duration_ns', 'use_state_discrimination', 'num_shots', 'log_or_linear_sweep', 'wait_time_num_points', 'use_waveform_report', 'qubits', 'multiplexed', 'min_wait_time_in_ns', 'load_data_id', 'frequency_detuning_in_mhz', 'timeout', 'simulate', 'max_wait_time_in_ns'}` |  |
