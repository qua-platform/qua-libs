...
| `model_fields_set` | `{'simulate', 'multiplexed', 'num_shots', 'simulation_duration_ns', 'log_or_linear_sweep', 'min_wait_time_in_ns', 'reset_type', 'use_state_discrimination', 'use_waveform_report', 'load_data_id', 'qubits', 'wait_time_num_points', 'timeout', 'max_wait_time_in_ns', 'frequency_detuning_in_mhz'}` |  |
