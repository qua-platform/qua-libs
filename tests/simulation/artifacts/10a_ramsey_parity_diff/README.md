...
| `model_fields_set` | `{'reset_type', 'timeout', 'simulate', 'load_data_id', 'qubits', 'min_wait_time_in_ns', 'max_wait_time_in_ns', 'log_or_linear_sweep', 'frequency_detuning_in_mhz', 'use_waveform_report', 'simulation_duration_ns', 'use_state_discrimination', 'num_shots', 'wait_time_num_points', 'multiplexed'}` |  |
