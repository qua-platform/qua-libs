...
| `model_fields_set` | `{'multiplexed', 'max_wait_time_in_ns', 'qubits', 'wait_time_num_points', 'simulation_duration_ns', 'simulate', 'use_waveform_report', 'timeout', 'load_data_id', 'log_or_linear_sweep', 'num_shots', 'use_state_discrimination', 'frequency_detuning_in_mhz', 'min_wait_time_in_ns', 'reset_type'}` |  |
