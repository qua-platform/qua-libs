...
| `model_fields_set` | `{'max_wait_time_in_ns', 'operation', 'qubits', 'reset_wait_time', 'multiplexed', 'time_step_in_ns', 'simulate', 'simulation_duration_ns', 'num_shots', 'min_wait_time_in_ns', 'load_data_id', 'frequency_span_in_mhz', 'use_waveform_report', 'frequency_step_in_mhz', 'use_state_discrimination', 'timeout'}` |  |
