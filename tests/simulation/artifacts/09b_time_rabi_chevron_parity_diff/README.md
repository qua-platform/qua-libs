...
| `model_fields_set` | `{'qubits', 'max_wait_time_in_ns', 'min_wait_time_in_ns', 'reset_wait_time', 'use_waveform_report', 'simulate', 'load_data_id', 'frequency_span_in_mhz', 'operation', 'simulation_duration_ns', 'gap_wait_time_in_ns', 'num_shots', 'time_step_in_ns', 'timeout', 'frequency_step_in_mhz', 'use_state_discrimination', 'multiplexed'}` |  |
