...
| `model_fields_set` | `{'multiplexed', 'max_wait_time_in_ns', 'qubits', 'reset_wait_time', 'time_step_in_ns', 'frequency_span_in_mhz', 'simulation_duration_ns', 'simulate', 'use_waveform_report', 'timeout', 'load_data_id', 'frequency_step_in_mhz', 'operation', 'num_shots', 'use_state_discrimination', 'min_wait_time_in_ns'}` |  |
