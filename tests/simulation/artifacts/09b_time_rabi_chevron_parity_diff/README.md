...
| `model_fields_set` | `{'qubits', 'use_waveform_report', 'simulate', 'multiplexed', 'time_step_in_ns', 'min_wait_time_in_ns', 'max_wait_time_in_ns', 'frequency_span_in_mhz', 'frequency_step_in_mhz', 'operation', 'simulation_duration_ns', 'load_data_id', 'num_shots', 'reset_wait_time', 'timeout', 'use_state_discrimination'}` |  |
