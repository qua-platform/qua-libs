...
| `model_fields_set` | `{'use_waveform_report', 'load_data_id', 'qubits', 'multiplexed', 'min_wait_time_in_ns', 'simulation_duration_ns', 'timeout', 'num_shots', 'use_state_discrimination', 'operation', 'frequency_span_in_mhz', 'frequency_step_in_mhz', 'max_wait_time_in_ns', 'reset_wait_time', 'time_step_in_ns', 'simulate'}` |  |
