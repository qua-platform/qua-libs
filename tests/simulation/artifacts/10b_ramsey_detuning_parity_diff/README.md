...
| `model_fields_set` | `{'detuning_span_in_mhz', 'idle_time_long_ns', 'gap_wait_time_in_ns', 'multiplexed', 'simulate', 'use_waveform_report', 'detuning_step_in_mhz', 'reset_type', 'qubits', 'timeout', 'idle_time_ns', 'num_shots', 'load_data_id', 'use_state_discrimination', 'simulation_duration_ns'}` |  |
