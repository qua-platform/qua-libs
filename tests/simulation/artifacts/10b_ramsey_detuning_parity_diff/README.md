...
| `model_fields_set` | `{'multiplexed', 'detuning_span_in_mhz', 'qubits', 'idle_time_ns', 'simulation_duration_ns', 'simulate', 'use_waveform_report', 'timeout', 'load_data_id', 'idle_time_long_ns', 'num_shots', 'use_state_discrimination', 'detuning_step_in_mhz', 'reset_type'}` |  |
