...
| `model_fields_set` | `{'gap_wait_time_in_ns', 'reset_type', 'simulation_duration_ns', 'detuning_span_in_mhz', 'use_state_discrimination', 'detuning_step_in_mhz', 'idle_time_ns', 'num_shots', 'use_waveform_report', 'qubits', 'multiplexed', 'load_data_id', 'idle_time_long_ns', 'timeout', 'simulate'}` |  |
