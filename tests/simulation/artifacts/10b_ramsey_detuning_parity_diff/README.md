...
| `model_fields_set` | `{'use_waveform_report', 'idle_time_ns', 'num_shots', 'simulation_duration_ns', 'reset_type', 'qubits', 'detuning_step_in_mhz', 'timeout', 'use_state_discrimination', 'idle_time_long_ns', 'detuning_span_in_mhz', 'load_data_id', 'simulate', 'multiplexed'}` |  |
