...
| `model_fields_set` | `{'ramp_duration', 'labeled_states', 'operation', 'detuning_points', 'simulate', 'timeout', 'detuning_max', 'buffer_duration', 'optimization_metric', 'simulation_duration_ns', 'sweep_name', 'use_waveform_report', 'load_data_id', 'detuning_min', 'reset_wait_time', 'use_state_discrimination', 'multiplexed', 'num_shots', 'qubit_pairs'}` |  |
