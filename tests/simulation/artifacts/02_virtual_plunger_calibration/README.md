...
| `model_fields_set` | `{'result_type', 'run_in_video_mode', 'hold_duration', 'sensor_names', 'virtual_gate_set_id', 'plunger_device_mapping', 'plunger_gate_points', 'device_gate_span', 'timeout', 'device_gate_from_qdac', 'simulation_duration_ns', 'post_trigger_wait_ns', 'device_gate_points', 'plunger_gate_span', 'num_shots', 'use_waveform_report', 'scan_pattern', 'ramp_duration', 'pre_measurement_delay', 'load_data_id', 'per_line_compensation', 'video_mode_port', 'dc_control', 'simulate', 'plunger_gate_from_qdac'}` |  |
