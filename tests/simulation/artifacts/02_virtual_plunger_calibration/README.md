...
| `model_fields_set` | `{'video_mode_port', 'timeout', 'result_type', 'device_gate_span', 'device_gate_from_qdac', 'per_line_compensation', 'sensor_names', 'ramp_duration', 'simulate', 'plunger_device_mapping', 'simulation_duration_ns', 'pre_measurement_delay', 'use_waveform_report', 'device_gate_points', 'dc_control', 'post_trigger_wait_ns', 'virtual_gate_set_id', 'plunger_gate_points', 'num_shots', 'plunger_gate_span', 'load_data_id', 'run_in_video_mode', 'scan_pattern', 'plunger_gate_from_qdac', 'hold_duration'}` |  |
