...
| `model_fields_set` | `{'sensor_names', 'hold_duration', 'simulate', 'run_in_video_mode', 'device_gate_from_qdac', 'timeout', 'pre_measurement_delay', 'plunger_gate_span', 'device_gate_points', 'plunger_gate_from_qdac', 'device_gate_span', 'simulation_duration_ns', 'dc_control', 'virtual_gate_set_id', 'plunger_device_mapping', 'result_type', 'num_shots', 'video_mode_port', 'plunger_gate_points', 'use_waveform_report', 'load_data_id', 'ramp_duration', 'per_line_compensation', 'scan_pattern', 'post_trigger_wait_ns'}` |  |
