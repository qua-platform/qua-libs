...
| `model_fields_set` | `{'operation', 'use_waveform_report', 'num_shots', 'simulation_duration_ns', 'tau_max', 'qubits', 'reset_wait_time', 'tau_step', 'timeout', 'use_state_discrimination', 'load_data_id', 'simulate', 'multiplexed', 'tau_min'}` |  |
