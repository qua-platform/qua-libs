...
| `model_fields_set` | `{'multiplexed', 'qubits', 'reset_wait_time', 'tau_max', 'simulation_duration_ns', 'simulate', 'use_waveform_report', 'timeout', 'load_data_id', 'operation', 'num_shots', 'tau_min', 'use_state_discrimination', 'tau_step'}` |  |
