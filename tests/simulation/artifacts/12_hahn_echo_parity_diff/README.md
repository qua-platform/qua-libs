...
| `model_fields_set` | `{'timeout', 'tau_min', 'use_state_discrimination', 'operation', 'load_data_id', 'simulation_duration_ns', 'simulate', 'qubits', 'reset_wait_time', 'use_waveform_report', 'multiplexed', 'gap_wait_time_in_ns', 'tau_step', 'num_shots', 'tau_max'}` |  |
