...
| `model_fields_set` | `{'tau_min', 'multiplexed', 'reset_wait_time', 'simulate', 'use_waveform_report', 'simulation_duration_ns', 'tau_step', 'operation', 'num_shots', 'use_state_discrimination', 'tau_max', 'load_data_id', 'timeout', 'qubits'}` |  |
