...
| `model_fields_set` | `{'qubits', 'use_waveform_report', 'simulate', 'multiplexed', 'tau_max', 'tau_step', 'operation', 'simulation_duration_ns', 'load_data_id', 'num_shots', 'reset_wait_time', 'timeout', 'tau_min', 'use_state_discrimination'}` |  |
