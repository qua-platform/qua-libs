...
| `model_fields_set` | `{'operation', 'qubits', 'reset_wait_time', 'multiplexed', 'simulate', 'simulation_duration_ns', 'num_shots', 'tau_step', 'load_data_id', 'tau_max', 'use_waveform_report', 'tau_min', 'use_state_discrimination', 'timeout'}` |  |
