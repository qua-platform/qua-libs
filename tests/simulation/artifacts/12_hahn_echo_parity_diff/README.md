...
| `model_fields_set` | `{'use_waveform_report', 'load_data_id', 'qubits', 'multiplexed', 'tau_min', 'timeout', 'num_shots', 'use_state_discrimination', 'operation', 'tau_step', 'simulation_duration_ns', 'tau_max', 'reset_wait_time', 'simulate'}` |  |
