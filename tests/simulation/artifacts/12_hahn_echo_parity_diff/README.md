...
| `model_fields_set` | `{'simulate', 'multiplexed', 'num_shots', 'operation', 'simulation_duration_ns', 'tau_max', 'use_state_discrimination', 'use_waveform_report', 'load_data_id', 'reset_wait_time', 'tau_min', 'qubits', 'tau_step', 'timeout'}` |  |
