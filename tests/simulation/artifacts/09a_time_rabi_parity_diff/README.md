...
| `model_fields_set` | `{'gap_wait_time_in_ns', 'simulation_duration_ns', 'use_state_discrimination', 'num_shots', 'use_waveform_report', 'qubits', 'multiplexed', 'min_wait_time_in_ns', 'time_step_in_ns', 'operation', 'load_data_id', 'reset_wait_time', 'timeout', 'simulate', 'max_wait_time_in_ns'}` |  |
