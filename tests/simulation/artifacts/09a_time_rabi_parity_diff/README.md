...
| `model_fields_set` | `{'min_wait_time_in_ns', 'multiplexed', 'reset_wait_time', 'simulate', 'use_waveform_report', 'simulation_duration_ns', 'operation', 'num_shots', 'load_data_id', 'use_state_discrimination', 'time_step_in_ns', 'timeout', 'qubits', 'max_wait_time_in_ns'}` |  |
