...
| `model_fields_set` | `{'simulate', 'multiplexed', 'num_shots', 'operation', 'simulation_duration_ns', 'min_wait_time_in_ns', 'use_state_discrimination', 'use_waveform_report', 'load_data_id', 'reset_wait_time', 'qubits', 'timeout', 'max_wait_time_in_ns', 'time_step_in_ns'}` |  |
