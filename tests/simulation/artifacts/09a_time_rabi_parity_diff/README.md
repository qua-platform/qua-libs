...
| `model_fields_set` | `{'max_wait_time_in_ns', 'use_waveform_report', 'simulation_duration_ns', 'operation', 'num_shots', 'simulate', 'multiplexed', 'load_data_id', 'qubits', 'timeout', 'min_wait_time_in_ns', 'use_state_discrimination', 'time_step_in_ns', 'reset_wait_time'}` |  |
