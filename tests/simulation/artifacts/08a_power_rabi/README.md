...
| `model_fields_set` | `{'use_waveform_report', 'load_data_id', 'qubits', 'multiplexed', 'reset_type', 'timeout', 'num_shots', 'max_amp_factor', 'use_state_discrimination', 'operation', 'amp_factor_step', 'simulation_duration_ns', 'min_amp_factor', 'simulate'}` |  |
