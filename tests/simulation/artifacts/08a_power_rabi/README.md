...
| `model_fields_set` | `{'gap_wait_time_in_ns', 'reset_type', 'simulation_duration_ns', 'use_state_discrimination', 'num_shots', 'min_amp_factor', 'use_waveform_report', 'qubits', 'multiplexed', 'operation', 'max_amp_factor', 'amp_factor_step', 'update_x90', 'load_data_id', 'timeout', 'simulate'}` |  |
