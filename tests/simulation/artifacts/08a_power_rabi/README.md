...
| `model_fields_set` | `{'multiplexed', 'qubits', 'update_x90', 'simulation_duration_ns', 'simulate', 'use_waveform_report', 'timeout', 'load_data_id', 'operation', 'max_amp_factor', 'amp_factor_step', 'min_amp_factor', 'num_shots', 'use_state_discrimination', 'reset_type'}` |  |
