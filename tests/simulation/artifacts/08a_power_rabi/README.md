...
| `model_fields_set` | `{'reset_type', 'min_amp_factor', 'multiplexed', 'simulate', 'use_waveform_report', 'amp_factor_step', 'simulation_duration_ns', 'max_amp_factor', 'operation', 'num_shots', 'update_x90', 'use_state_discrimination', 'load_data_id', 'timeout', 'qubits'}` |  |
