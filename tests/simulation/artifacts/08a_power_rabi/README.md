...
| `model_fields_set` | `{'qubits', 'use_waveform_report', 'simulate', 'multiplexed', 'max_amp_factor', 'amp_factor_step', 'operation', 'simulation_duration_ns', 'load_data_id', 'num_shots', 'min_amp_factor', 'reset_type', 'use_state_discrimination', 'timeout'}` |  |
