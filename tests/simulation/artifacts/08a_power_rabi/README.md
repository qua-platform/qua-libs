...
|-----------|-------|-------------|
| `amp_factor_step` | `0.005` | Step size for the amplitude factor. Default is 0.005. |
| `gap_wait_time_in_ns` | `32` | Wait time between initialization and qubit pulse in nanoseconds. Default is 128 ns. |
...
| `model_fields_set` | `{'timeout', 'qubits', 'load_data_id', 'min_amp_factor', 'use_state_discrimination', 'multiplexed', 'gap_wait_time_in_ns', 'operation', 'max_amp_factor', 'use_waveform_report', 'reset_type', 'update_x90', 'num_shots', 'simulation_duration_ns', 'amp_factor_step', 'simulate'}` |  |
