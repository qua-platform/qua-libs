...
| `model_fields_set` | `{'use_waveform_report', 'simulation_duration_ns', 'operation', 'num_shots', 'max_amp_factor', 'simulate', 'multiplexed', 'load_data_id', 'qubits', 'reset_type', 'update_x90', 'amp_factor_step', 'min_amp_factor', 'timeout', 'use_state_discrimination'}` |  |
