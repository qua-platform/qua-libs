...
| `model_fields_set` | `{'gap_wait_time_in_ns', 'min_amp_factor', 'reset_type', 'operation', 'qubits', 'simulate', 'timeout', 'max_amp_factor', 'amp_factor_step', 'use_state_discrimination', 'multiplexed', 'num_shots', 'update_x90', 'simulation_duration_ns', 'use_waveform_report', 'load_data_id'}` |  |
