...
| `model_fields_set` | `{'update_x90', 'multiplexed', 'num_shots', 'qubits', 'amp_factor_step', 'use_waveform_report', 'use_state_discrimination', 'reset_type', 'min_amp_factor', 'timeout', 'operation', 'simulate', 'load_data_id', 'simulation_duration_ns', 'max_amp_factor'}` |  |
