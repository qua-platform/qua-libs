...
| `model_fields_set` | `{'reset_wait_time', 'num_shots', 'operation_x90', 'simulate', 'use_state_discrimination', 'timeout', 'delta_clifford', 'load_data_id', 'qubits', 'gap_wait_time_in_ns', 'num_circuits_per_length', 'max_circuit_depth', 'log_scale', 'seed', 'operation_x180', 'simulation_duration_ns', 'multiplexed', 'use_waveform_report'}` |  |
