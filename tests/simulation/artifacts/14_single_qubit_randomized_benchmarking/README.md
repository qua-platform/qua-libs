...
| `gap_wait_time_in_ns` | `1056` | Initialization hold time in nanoseconds (e.g. 400 µs). Default is 400_000. |
...
| `model_fields_set` | `{'gap_wait_time_in_ns', 'num_circuits_per_length', 'num_shots', 'use_state_discrimination', 'operation_x90', 'operation_x180', 'timeout', 'log_scale', 'reset_wait_time', 'simulate', 'multiplexed', 'qubits', 'max_circuit_depth', 'simulation_duration_ns', 'delta_clifford', 'seed', 'load_data_id', 'use_waveform_report'}` |  |
