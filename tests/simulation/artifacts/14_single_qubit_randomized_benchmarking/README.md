...
| `model_fields_set` | `{'operation_x90', 'max_circuit_depth', 'delta_clifford', 'seed', 'simulation_duration_ns', 'simulate', 'load_data_id', 'timeout', 'use_waveform_report', 'operation_x180', 'num_shots', 'log_scale', 'qubits', 'reset_wait_time', 'use_state_discrimination', 'multiplexed', 'num_circuits_per_length'}` |  |
