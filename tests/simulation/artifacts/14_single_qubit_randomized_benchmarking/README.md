...
| `model_fields_set` | `{'num_circuits_per_length', 'use_waveform_report', 'load_data_id', 'qubits', 'multiplexed', 'operation_x180', 'simulation_duration_ns', 'operation_x90', 'timeout', 'num_shots', 'seed', 'use_state_discrimination', 'max_circuit_depth', 'log_scale', 'delta_clifford', 'reset_wait_time', 'simulate'}` |  |
