...
| `model_fields_set` | `{'qubits', 'operation_x90', 'max_circuit_depth', 'log_scale', 'simulate', 'use_waveform_report', 'multiplexed', 'delta_clifford', 'operation_x180', 'seed', 'num_circuits_per_length', 'simulation_duration_ns', 'load_data_id', 'num_shots', 'reset_wait_time', 'timeout', 'use_state_discrimination'}` |  |
