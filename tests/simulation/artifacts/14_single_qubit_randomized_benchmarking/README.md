...
| `model_fields_set` | `{'simulate', 'multiplexed', 'num_shots', 'num_circuits_per_length', 'log_scale', 'seed', 'simulation_duration_ns', 'use_state_discrimination', 'use_waveform_report', 'delta_clifford', 'reset_wait_time', 'operation_x90', 'operation_x180', 'load_data_id', 'qubits', 'timeout', 'max_circuit_depth'}` |  |
