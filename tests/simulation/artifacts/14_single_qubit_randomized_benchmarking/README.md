...
| `model_fields_set` | `{'use_waveform_report', 'num_shots', 'simulation_duration_ns', 'max_circuit_depth', 'operation_x180', 'log_scale', 'qubits', 'reset_wait_time', 'operation_x90', 'num_circuits_per_length', 'use_state_discrimination', 'timeout', 'load_data_id', 'simulate', 'multiplexed', 'seed', 'delta_clifford'}` |  |
