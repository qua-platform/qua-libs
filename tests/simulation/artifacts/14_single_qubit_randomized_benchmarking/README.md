...
| `model_fields_set` | `{'log_scale', 'seed', 'qubits', 'reset_wait_time', 'multiplexed', 'simulate', 'simulation_duration_ns', 'operation_x90', 'max_circuit_depth', 'num_shots', 'num_circuits_per_length', 'delta_clifford', 'load_data_id', 'use_waveform_report', 'use_state_discrimination', 'operation_x180', 'timeout'}` |  |
