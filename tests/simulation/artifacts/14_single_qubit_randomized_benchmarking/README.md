...
| `model_fields_set` | `{'multiplexed', 'operation_x180', 'qubits', 'reset_wait_time', 'num_circuits_per_length', 'operation_x90', 'simulation_duration_ns', 'simulate', 'max_circuit_depth', 'use_waveform_report', 'timeout', 'load_data_id', 'seed', 'num_shots', 'delta_clifford', 'use_state_discrimination', 'log_scale'}` |  |
