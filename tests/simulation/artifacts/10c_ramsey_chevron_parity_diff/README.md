...
| `model_fields_set` | `{'qubits', 'use_waveform_report', 'simulate', 'multiplexed', 'detuning_step_in_mhz', 'min_wait_time_in_ns', 'max_wait_time_in_ns', 'wait_time_num_points', 'detuning_span_in_mhz', 'simulation_duration_ns', 'log_or_linear_sweep', 'load_data_id', 'num_shots', 'reset_type', 'use_state_discrimination', 'timeout'}` |  |
