...
| `model_fields_set` | `{'gap_wait_time_in_ns', 'reset_type', 'simulation_duration_ns', 'detuning_span_in_mhz', 'use_state_discrimination', 'detuning_step_in_mhz', 'num_shots', 'log_or_linear_sweep', 'wait_time_num_points', 'use_waveform_report', 'qubits', 'multiplexed', 'min_wait_time_in_ns', 'load_data_id', 'timeout', 'simulate', 'max_wait_time_in_ns'}` |  |
