...
| `model_fields_set` | `{'use_waveform_report', 'num_shots', 'log_or_linear_sweep', 'simulation_duration_ns', 'min_wait_time_in_ns', 'reset_type', 'wait_time_num_points', 'qubits', 'max_wait_time_in_ns', 'timeout', 'detuning_step_in_mhz', 'use_state_discrimination', 'detuning_span_in_mhz', 'load_data_id', 'simulate', 'multiplexed'}` |  |
