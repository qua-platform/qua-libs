...
| `model_fields_set` | `{'reset_type', 'timeout', 'simulate', 'detuning_span_in_mhz', 'load_data_id', 'qubits', 'min_wait_time_in_ns', 'max_wait_time_in_ns', 'log_or_linear_sweep', 'use_waveform_report', 'simulation_duration_ns', 'use_state_discrimination', 'detuning_step_in_mhz', 'num_shots', 'wait_time_num_points', 'multiplexed'}` |  |
