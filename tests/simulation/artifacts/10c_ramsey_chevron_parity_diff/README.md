...
| `model_fields_set` | `{'reset_type', 'min_wait_time_in_ns', 'log_or_linear_sweep', 'detuning_span_in_mhz', 'multiplexed', 'simulate', 'wait_time_num_points', 'use_waveform_report', 'simulation_duration_ns', 'num_shots', 'use_state_discrimination', 'load_data_id', 'detuning_step_in_mhz', 'timeout', 'qubits', 'max_wait_time_in_ns'}` |  |
