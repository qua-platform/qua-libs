...
| `model_fields_set` | `{'multiplexed', 'max_wait_time_in_ns', 'detuning_span_in_mhz', 'qubits', 'wait_time_num_points', 'simulation_duration_ns', 'simulate', 'use_waveform_report', 'timeout', 'load_data_id', 'log_or_linear_sweep', 'detuning_step_in_mhz', 'num_shots', 'use_state_discrimination', 'min_wait_time_in_ns', 'reset_type'}` |  |
