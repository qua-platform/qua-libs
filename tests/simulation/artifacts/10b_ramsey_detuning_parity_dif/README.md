...
| `model_fields_set` | `{'simulate', 'multiplexed', 'num_shots', 'detuning_step_in_mhz', 'simulation_duration_ns', 'reset_type', 'use_state_discrimination', 'use_waveform_report', 'load_data_id', 'detuning_span_in_mhz', 'qubits', 'idle_time_long_ns', 'timeout', 'idle_time_ns'}` |  |
