...
| `model_fields_set` | `{'qubits', 'use_waveform_report', 'simulate', 'multiplexed', 'detuning_step_in_mhz', 'detuning_span_in_mhz', 'simulation_duration_ns', 'load_data_id', 'num_shots', 'idle_time_ns', 'reset_type', 'idle_time_long_ns', 'use_state_discrimination', 'timeout'}` |  |
