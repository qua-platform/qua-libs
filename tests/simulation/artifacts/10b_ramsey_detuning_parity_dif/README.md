...
| `model_fields_set` | `{'use_waveform_report', 'detuning_span_in_mhz', 'load_data_id', 'qubits', 'multiplexed', 'detuning_step_in_mhz', 'reset_type', 'num_shots', 'use_state_discrimination', 'simulation_duration_ns', 'idle_time_long_ns', 'timeout', 'idle_time_ns', 'simulate'}` |  |
