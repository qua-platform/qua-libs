...
| `model_fields_set` | `{'reset_type', 'idle_time_ns', 'detuning_span_in_mhz', 'multiplexed', 'simulate', 'use_waveform_report', 'idle_time_long_ns', 'simulation_duration_ns', 'num_shots', 'use_state_discrimination', 'load_data_id', 'detuning_step_in_mhz', 'timeout', 'qubits'}` |  |
