...
| `model_fields_set` | `{'num_shots', 'num_power_points', 'timeout', 'buffer_from_crossing_threshold_in_dbm', 'multiplexed', 'use_state_discrimination', 'reset_wait_time', 'frequency_span_in_mhz', 'sensor_names', 'max_amp', 'derivative_smoothing_window_num_points', 'use_waveform_report', 'simulate', 'simulation_duration_ns', 'load_data_id', 'max_power_dbm', 'derivative_crossing_threshold_in_hz_per_dbm', 'moving_average_filter_window_num_points', 'frequency_step_in_mhz', 'min_power_dbm'}` |  |
