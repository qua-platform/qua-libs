...
| `model_fields_set` | `{'sensor_names', 'use_state_discrimination', 'timeout', 'frequency_step_in_mhz', 'simulation_duration_ns', 'min_power_dbm', 'buffer_from_crossing_threshold_in_dbm', 'derivative_smoothing_window_num_points', 'reset_wait_time', 'num_shots', 'moving_average_filter_window_num_points', 'use_waveform_report', 'num_power_points', 'load_data_id', 'multiplexed', 'max_amp', 'frequency_span_in_mhz', 'derivative_crossing_threshold_in_hz_per_dbm', 'simulate', 'max_power_dbm'}` |  |
