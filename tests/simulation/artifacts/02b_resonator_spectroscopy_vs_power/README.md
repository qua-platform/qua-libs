...
| `model_fields_set` | `{'reset_wait_time', 'frequency_span_in_mhz', 'max_amp', 'use_state_discrimination', 'multiplexed', 'max_power_dbm', 'simulation_duration_ns', 'timeout', 'load_data_id', 'frequency_step_in_mhz', 'num_shots', 'derivative_crossing_threshold_in_hz_per_dbm', 'buffer_from_crossing_threshold_in_dbm', 'use_waveform_report', 'derivative_smoothing_window_num_points', 'sensor_names', 'simulate', 'moving_average_filter_window_num_points', 'min_power_dbm', 'num_power_points'}` |  |
