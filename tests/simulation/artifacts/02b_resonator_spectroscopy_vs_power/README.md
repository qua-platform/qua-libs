...
| `model_fields_set` | `{'max_amp', 'num_power_points', 'num_shots', 'timeout', 'reset_wait_time', 'max_power_dbm', 'derivative_smoothing_window_num_points', 'load_data_id', 'multiplexed', 'sensor_names', 'moving_average_filter_window_num_points', 'simulation_duration_ns', 'frequency_span_in_mhz', 'simulate', 'use_waveform_report', 'use_state_discrimination', 'frequency_step_in_mhz', 'derivative_crossing_threshold_in_hz_per_dbm', 'min_power_dbm', 'buffer_from_crossing_threshold_in_dbm'}` |  |
