...
| `model_fields_set` | `{'multiplexed', 'frequency_span_in_mhz', 'derivative_smoothing_window_num_points', 'simulation_duration_ns', 'reset_wait_time', 'min_power_dbm', 'num_power_points', 'load_data_id', 'derivative_crossing_threshold_in_hz_per_dbm', 'use_waveform_report', 'num_shots', 'use_state_discrimination', 'frequency_step_in_mhz', 'buffer_from_crossing_threshold_in_dbm', 'simulate', 'max_power_dbm', 'max_amp', 'moving_average_filter_window_num_points', 'sensor_names', 'timeout'}` |  |
