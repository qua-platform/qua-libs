...
| `model_fields_set` | `{'frequency_span_in_mhz', 'frequency_step_in_mhz', 'num_power_points', 'simulation_duration_ns', 'num_shots', 'sensor_names', 'min_power_dbm', 'reset_wait_time', 'timeout', 'buffer_from_crossing_threshold_in_dbm', 'use_waveform_report', 'multiplexed', 'max_power_dbm', 'use_state_discrimination', 'simulate', 'max_amp', 'derivative_crossing_threshold_in_hz_per_dbm', 'moving_average_filter_window_num_points', 'load_data_id', 'derivative_smoothing_window_num_points'}` |  |
