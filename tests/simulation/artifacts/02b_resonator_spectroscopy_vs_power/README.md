...
| `model_fields_set` | `{'num_power_points', 'buffer_from_crossing_threshold_in_dbm', 'use_state_discrimination', 'num_shots', 'load_data_id', 'frequency_span_in_mhz', 'simulation_duration_ns', 'sensor_names', 'moving_average_filter_window_num_points', 'frequency_step_in_mhz', 'derivative_smoothing_window_num_points', 'max_power_dbm', 'timeout', 'simulate', 'min_power_dbm', 'use_waveform_report', 'multiplexed', 'reset_wait_time', 'max_amp', 'derivative_crossing_threshold_in_hz_per_dbm'}` |  |
