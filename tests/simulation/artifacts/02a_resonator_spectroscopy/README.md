...
| `model_fields_set` | `{'simulate', 'num_shots', 'multiplexed', 'simulation_duration_ns', 'use_state_discrimination', 'use_waveform_report', 'load_data_id', 'reset_wait_time', 'frequency_span_in_mhz', 'sensor_names', 'timeout', 'frequency_step_in_mhz'}` |  |
