...
| `model_fields_set` | `{'use_waveform_report', 'load_data_id', 'multiplexed', 'sensor_names', 'simulation_duration_ns', 'reset_wait_time', 'num_shots', 'use_state_discrimination', 'frequency_step_in_mhz', 'timeout', 'frequency_span_in_mhz', 'simulate'}` |  |
