...
| `model_fields_set` | `{'simulate', 'multiplexed', 'reset_wait_time', 'use_waveform_report', 'frequency_span_in_mhz', 'load_data_id', 'num_shots', 'sensor_names', 'use_state_discrimination', 'frequency_step_in_mhz', 'timeout', 'simulation_duration_ns'}` |  |
