...
| `model_fields_set` | `{'multiplexed', 'frequency_span_in_mhz', 'reset_wait_time', 'simulation_duration_ns', 'simulate', 'use_waveform_report', 'timeout', 'load_data_id', 'frequency_step_in_mhz', 'num_shots', 'use_state_discrimination', 'sensor_names'}` |  |
