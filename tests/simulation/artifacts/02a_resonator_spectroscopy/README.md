...
| `model_fields_set` | `{'multiplexed', 'num_shots', 'sensor_names', 'use_waveform_report', 'use_state_discrimination', 'frequency_span_in_mhz', 'timeout', 'frequency_step_in_mhz', 'reset_wait_time', 'simulate', 'load_data_id', 'simulation_duration_ns'}` |  |
