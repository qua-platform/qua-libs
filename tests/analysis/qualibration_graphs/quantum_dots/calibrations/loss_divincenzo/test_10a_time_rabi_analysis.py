...
def test_10a_time_rabi_analysis(ld_device, analysis_runner):
    ...
    node = analysis_runner(
        ...
        param_overrides={
            ...
            "time_step_in_ns": (
                MAX_DURATION_NS // N_DURATION_POINTS if N_DURATION_POINTS > 1 else 4
            ),
        },
    )
    ...
    assert (
        sinusoid is not None
    ), "Damped sinusoid fit should succeed on clean simulation data"
