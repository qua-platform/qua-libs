...
|-----------|-------|-------------|
| `gap_wait_time_in_ns` | `128` | Wait time between initialisation and the echo sequence in nanoseconds. Default is 128 ns. |
...
| `model_fields_set` | `{'qubits', 'tau_step', 'tau_min', 'num_shots', 'simulate', 'tau_max'}` |  |
