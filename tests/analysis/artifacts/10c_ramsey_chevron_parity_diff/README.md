...
| `detuning_step_in_mhz` | `0.2` | Frequency detuning step. Default 0.1MHz |
| `load_data_id` | `None` | Optional QUAlibrate node run index for loading historical data. Default is None. |
| `log_or_linear_sweep` | `log` | Type of sweep, either "log" (logarithmic) or "linear". Default is "log". |
| `max_wait_time_in_ns` | `400` | Maximum wait time in nanoseconds. Default is 30000. |
...
| `model_fields_set` | `{'detuning_step_in_mhz', 'max_wait_time_in_ns', 'wait_time_num_points', 'qubits', 'simulate', 'min_wait_time_in_ns', 'detuning_span_in_mhz', 'num_shots'}` |  |
...
|-------|-------------|----------|--------------|----------|----------|--------|
| q1 | 0.0000 | nan | nan | 0.00467 | 214 | True |
