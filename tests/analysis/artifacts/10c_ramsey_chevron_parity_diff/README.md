...
| `model_fields_set` | `{'detuning_span_in_mhz', 'min_wait_time_in_ns', 'simulate', 'qubits', 'wait_time_num_points', 'detuning_step_in_mhz', 'max_wait_time_in_ns', 'num_shots'}` |  |
...
|-------|-------------|----------|--------------|----------|----------|--------|
| q1 | 0.0000 | nan | nan | 0.00235 | 426 | True |
