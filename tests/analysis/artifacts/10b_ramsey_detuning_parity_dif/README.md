...
| `model_fields_set` | `{'detuning_span_in_mhz', 'simulate', 'idle_time_ns', 'qubits', 'detuning_step_in_mhz', 'idle_time_long_ns', 'num_shots'}` |  |
...
|-------|-------------|----------|--------------|----------|----------|--------|
| q1 | 0.0000 | nan | nan | 0.00048 | 2104 | True |
