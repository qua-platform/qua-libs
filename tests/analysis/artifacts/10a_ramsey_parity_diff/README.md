...
| `model_fields_set` | `{'wait_time_num_points', 'max_wait_time_in_ns', 'frequency_detuning_in_mhz', 'simulate', 'qubits', 'min_wait_time_in_ns', 'num_shots'}` |  |
...
|-------|-------------|----------|--------------|----------|----------|--------|
| Q1 | 0.0000 | nan | nan | 0.00173 | 578 | True |
