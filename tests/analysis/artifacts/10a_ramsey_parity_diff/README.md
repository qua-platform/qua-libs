...
| `model_fields_set` | `{'min_wait_time_in_ns', 'simulate', 'qubits', 'frequency_detuning_in_mhz', 'wait_time_num_points', 'max_wait_time_in_ns', 'num_shots'}` |  |
...
|-------|-------------|----------|--------------|----------|----------|--------|
| q1 | 0.0000 | nan | nan | 0.00007 | 14155 | True |
