...
| `model_fields_set` | `{'wait_time_num_points', 'max_wait_time_in_ns', 'qubits', 'frequency_detuning_in_mhz', 'simulate', 'num_shots', 'min_wait_time_in_ns'}` |  |
...
|-------|-------------|----------|--------------|----------|----------|--------|
| q1 | 0.0000 | nan | nan | 0.00259 | 386 | True |
