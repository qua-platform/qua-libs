...
| `tau_max` | `3000` | Maximum Hahn echo idle delay τ in nanoseconds (each x90–y180 segment; total evolution 2τ). Default is 10 000 ns (10 µs per segment; 20 µs total evolution). |
| `tau_step` | `40` | Step size for the τ sweep in nanoseconds. Default is 100 ns (25 QUA clock cycles). |
...
|-------|-------------|----------|--------------|----------|----------|--------|
| q1 | 0.0000 | nan | nan | 0.00103 | 973 | True |
| q2 | 0.0000 | nan | nan | 0.00104 | 962 | True |
