...
| `model_fields_set` | `{'frequency_step_in_mhz', 'frequency_span_in_mhz', 'min_wait_time_in_ns', 'max_wait_time_in_ns', 'time_step_in_ns', 'qubits', 'num_shots', 'simulate'}` |  |
...
|-------|-------------|----------|--------------|----------|----------|--------|
| Q1 | 9.9999 | 62.8 | 0.050057 | 0.00775 | 129 | True |
