...
| `model_fields_set` | `{'max_wait_time_in_ns', 'time_step_in_ns', 'qubits', 'frequency_step_in_mhz', 'simulate', 'min_wait_time_in_ns', 'num_shots', 'frequency_span_in_mhz'}` |  |
...
|-------|-------------|----------|--------------|----------|----------|--------|
| q1 | 10.0007 | 62.8 | 0.050017 | 0.00706 | 142 | True |
