...
| `model_fields_set` | `{'time_step_in_ns', 'min_wait_time_in_ns', 'simulate', 'frequency_step_in_mhz', 'frequency_span_in_mhz', 'qubits', 'max_wait_time_in_ns', 'num_shots'}` |  |
...
|-------|-------------|----------|--------------|----------|----------|--------|
| q1 | 9.9977 | 63.0 | 0.049867 | 0.00705 | 142 | True |
