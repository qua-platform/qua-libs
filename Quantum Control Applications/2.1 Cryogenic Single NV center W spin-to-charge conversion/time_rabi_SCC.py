...
with program() as time_rabi_SCC:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        ...
        with for_(t, t_min, t <= t_max, t + dt):
            ...
            play('gauss', 'qubit', duration=t)  # gaussian pulse of duration t cycles
            ...
            measure('photon_count', 'SNSPD', None,
                    time_tagging.analog(times, meas_len, counts))  # photon count
...
if simulate:
    qmm.simulate(config, time_rabi_SCC, SimulationConfig(10000)).get_simulated_samples().con1.plot()
else:
    job = qm.execute(time_rabi_SCC)  # execute QUA program
