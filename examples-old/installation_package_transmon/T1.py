...
cooldown_time = 50000 // 4  # in units of clock cycle
...
with program() as t1:
    ...
    tau = declare(int)  # variable delay
    ...
    with for_(n, 0, n < N_max, n + 1):
        ...
        with for_(tau, times[0], tau <= times[-1], tau + dt):
            wait(cooldown_time, "qubit")  # for qubit to decay
            play("pi", "qubit")  # play pi pulse on qubit
            wait(tau, "qubit")  # decay time between pi pulse and resonator readout
