...
def plot_ar_attempts(ar_data: dict[str, np.typing.NDArray], **hist_kwargs):
    ...
    Example:
        ...
        from quam_builder.lib.plot_utils import plot_ar_attempts
        ar_dat = {}
...
class QubitPairGrid:
    ...
    '''
    from quam_builder.lib.qua_datasets import grid_iter
...
class QubitGrid:
    ...
    '''
    from quam_builder.lib.qua_datasets import grid_iter, QubitGrid
    grid = QubitGrid(ds)
    ...
    '''
    from quam_builder.lib.plot_utils import grid_iter, QubitGrid
