...
class NodeSpecificParameters(RunnableParameters):
    ...
    Attributes:
        ...
        derivative_smoothing_window_num_points (int): Size of the smoothing window for the derivative (number of points). Default is 10.
    ...
    derivative_smoothing_window_num_points: int = (
        10  # Size of the window in number of points corresponding to the rolling average
    )
