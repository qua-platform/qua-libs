...
def _extract_relevant_fit_parameters(fit: xr.Dataset, node: QualibrationNode):
    ...
    if node.parameters.max_number_rabi_pulses_per_sweep == 1:
        ...
        fit.opt_amp_prefactor.attrs = {"long_name": "factor to get a pi pulse", "units": "Hz"}
        ...
        fit.opt_amp.attrs = {"long_name": f"{node.parameters.operation} pulse amplitude", "units": "V"}
