...
def fit_raw_data(ds: xr.Dataset, node: QualibrationNode) -> Tuple[xr.Dataset, dict[str, FitParameters]]:
    ...
    # peaks = peaks_dips(ds.I, dim="detuning", prominence_factor=5)
    # # Fit the result with a parabola
    # parabolic_fit_results = peaks.position.polyfit("flux_bias", 2)
    ...
    # Find the minimum of each frequency line to follow the resonance vs flux
    peak_freq_1 = ds.IQ_abs.idxmin(dim="detuning")
