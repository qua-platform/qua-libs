qubit_pair_ports = ["control_qubit", "target_qubit"]

mw_in_channel_ports = ["opx_input"]
mw_out_channel_ports = ["opx_output"]
mw_in_out_channel_ports = mw_in_channel_ports + mw_out_channel_ports + qubit_pair_ports
...
iq_in_out_channel_ports = iq_in_channel_ports + iq_out_channel_ports + qubit_pair_ports
