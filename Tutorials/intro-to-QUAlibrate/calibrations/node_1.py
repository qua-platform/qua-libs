...
node = QualibrationNode[Parameters, Quam](name="node_1", description=description, parameters=Parameters())
...
def create_qua_program(node: QualibrationNode[Parameters, Quam]):
    ...
    frequencies = np.linspace(100e6, 200e6, 10e6)
    # Register the sweep axes to be added to the dataset when fetching data
    node.namespace["sweep_axes"] = {
        "qubit": xr.DataArray(qubits.get_names()),
        "frequency": xr.DataArray(frequencies, attrs={"long_name": "frequency", "units": "Hz"}),
    }
