...
![](../images/ion_trap.png){height=420}
...
![](../images/ion_energy_level.png){height=420}
...
\end{pmatrix}
$$
with the qubit index $k\isin\{1, 2\}$. The rotation angle $\theta_k$ about an axis on the Bloch sphere is determined by the relative amplitude $A/A_k^\pi$ where the amplitude $A_k^\pi$ is required for a $\pi$ rotation. Note that $A_k^\pi$ is also a measure of the Rabi frequency. By adjusting the DC confinement, the ions can displaced such that each of the ion experienced a different  magnetic-field gradient and thus different $A_k^\pi$.

![](../images/ion_global_rot.png){height=420}
...
![](../images/ion_system.png){height=420}
...
![](../images/protocol.png){height=420}

## 5. Optimizing parameters

![](../images/error_amplification.png){height=420}
