...
def charge_stability_patch(v1_start, v1_end, v2_start, v2_end, step, n_avg, qm):
    job = qm.simulate(scan2d(v1_start, v1_end, v2_start, v2_end, step, n_avg),
                      SimulationConfig(int(1e6), simulation_interface=LoopbackInterface
                      ([('con1', 1, 'con1', 1), ('con1', 2, 'con1', 1)]))
                      # TODO remove and change to execute
                      )
