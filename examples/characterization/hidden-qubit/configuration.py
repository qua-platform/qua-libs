...
config = {
    ...
    'mixers': {  # Potential corrections to be brought related to the IQ mixing scheme
        ...
        'mixer_TC': [
            {'intermediate_frequency': 0, 'lo_frequency': 5.00e7, 'correction': [1.0, 0.0, 0.0, 1.0]}
        ],
    }
}
...
def state_saving(I, Q, state_c, state_h, stream_c,
                 stream_h):  # Do state estimation protocol in QUA, and save the associated state
