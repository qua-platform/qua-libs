...
def cost(x):
    ...
    job = QM1.simulate(drag_prog(e=e),
                       SimulationConfig(int(3000)))
...
res = optimize.minimize(cost, x0=[1.2,0.3], method='nelder-mead',
...
job = QM1.simulate(RB_scan(e),
                   SimulationConfig(int(30000)))
