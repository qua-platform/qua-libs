...
config = {
        ...
        'controllers': {
            'con1': {
                'type': 'opx1',
                'analog_outputs': {
                    i + 1: {'offset': 0.0} for i in range(4)
                },
                'analog_inputs': {
                    1: {'offset': 0.0},
                    2: {'offset': 0.0},
        ...
        'waveforms': {
            ...
            'pi_over_two_C90_C414_wf': {
                'type': 'constant',
                'sample': 0.2
            },
            'pi_over_six_C90_N1_wf': {
                'type': 'constant',
                'sample': 0.2
            },
            'two_pi_over_six_C90_N2_wf': {
                'type': 'constant',
                'sample': 0.2
            },
            'pi_over_three_C414_N1_wf': {
                'type': 'constant',
                'sample': 0.2
            },
            'two_pi_over_three_C414_N2_wf': {
                'type': 'constant',
                'sample': 0.2
            },
            'pi_N_wf': {
