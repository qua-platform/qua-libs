    ...
    with for_(x, x_start, x <= x_end, x + x_step):
        with for_(y, y_start, y <= y_end, y + y_step):
            ...
            with for_(n,0,n<=N_avg,n+1):
                ...
                align('qubit', 'readout_el1','readout_el1')
                measure("readout", "readout_el1", None, time_tagging.raw(result1, meas_len, targetLen=resultLen1))  # 1ns
                measure("readout", "readout_el2", None, time_tagging.raw(result2, meas_len, targetLen=resultLen2))  # 1ns
                assign(n, 0)
