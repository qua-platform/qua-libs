...
qb_freqs = [51.223e6, 63.635e6, 72.11e6, 81.784e6, 95.533e6, 102.109e6, 110.662e6, 124.235e6, 129.1e6, 140e6]
freqs = [51.223e6, 63.635e6, 72.11e6, 81.784e6, 95.533e6, 102.109e6, 110.662e6, 124.235e6, 129.1e6, 140e6]
    ...
    config['elements']['qb' + str(i)] = \
        {
            'group': str(i),
            'mixInputs': {
                'I': ('con' + str(int(i / 5) + 1), (2 * i + 1) % 10 + ((2 * i + 1) % 10 == 0)*10),
                'Q': ('con' + str(int(i / 5) + 1), (2 * i + 2) % 10 + ((2 * i + 2) % 10 == 0)*10),
