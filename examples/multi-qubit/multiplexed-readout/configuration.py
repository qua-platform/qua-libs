...
config = {
    ...
    'mixers': {
        'mixer_WG1': [
            {'intermediate_frequency': rr1a_res_IF, 'lo_frequency': lo_freq, 'correction': [1, 0, 0, 1]},
        ],

        'mixer_WG2': [
            {'intermediate_frequency': rr2a_res_IF, 'lo_frequency': lo_freq, 'correction': [1, 0, 0, 1]},
        ],

        'mixer_WG3': [
            {'intermediate_frequency': rr3a_res_IF, 'lo_frequency': lo_freq, 'correction': [1, 0, 0, 1]},
        ],
    }
}
