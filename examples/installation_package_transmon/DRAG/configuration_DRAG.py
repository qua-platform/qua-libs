...
def drag_gaussian_pulse_waveforms(amplitude, length, sigma, alpha, detune, delta, substracted):
    ...
    gauss_der_wave = (
        amplitude * (-2 * 1e9 * (t - length/2) / (2 * sigma ** 2)) * np.exp(-((t - length/2) ** 2) / (2 * sigma ** 2))
...
drag_gauss_wf, drag_gauss_der_wf = drag_gaussian_pulse_waveforms(drag_amp, drag_len, drag_len / 5, drag_alpha, drag_del_f, drag_delta, substracted=False)  # pi pulse
drag_half_gauss_wf, drag_half_gauss_der_wf = drag_gaussian_pulse_waveforms(drag_amp * 0.5, drag_len, drag_len / 5, drag_alpha, drag_del_f, drag_delta, substracted=False)  # pi_half pulse
minus_drag_half_gauss_wf, minus_drag_half_gauss_der_wf = drag_gaussian_pulse_waveforms(drag_amp * (-0.5), drag_len, drag_len / 5, drag_alpha, drag_del_f, drag_delta, substracted=False)  # -pi_half pulse
minus_drag_gauss_wf, minus_drag_gauss_der_wf = drag_gaussian_pulse_waveforms(drag_amp * (-1), drag_len, drag_len / 5, drag_alpha, drag_del_f, drag_delta, substracted=False)  # -pi pulse

# Definition of I- and Q-quadratures DRAG waveforms for pi and pi_half pulses with a cosine envelope
drag_cos_wf, drag_sin_wf = drag_cosine_pulse_waveforms(drag_amp, drag_len, drag_alpha, drag_del_f, drag_delta)  # pi pulse
drag_half_cos_wf, drag_half_sin_wf = drag_cosine_pulse_waveforms(drag_amp * 0.5, drag_len, drag_alpha, drag_del_f, drag_delta)  # pi_half pulse
minus_drag_half_cos_wf, minus_drag_half_sin_wf = drag_cosine_pulse_waveforms(drag_amp * (-0.5), drag_len, drag_alpha, drag_del_f, drag_delta)  # -pi_half pulse
minus_drag_cos_wf, minus_drag_sin_wf = drag_cosine_pulse_waveforms(drag_amp * (-1), drag_len, drag_alpha, drag_del_f, drag_delta)  # -pi pulse
...
config = {
    ...
    "waveforms": {
        ...
        "DRAG_half_gauss_der_wf": {"type": "arbitrary", "samples": drag_half_gauss_der_wf},
        "-DRAG_half_gauss_wf": {"type": "arbitrary", "samples": minus_drag_half_gauss_wf},
        "-DRAG_half_gauss_der_wf": {"type": "arbitrary", "samples": minus_drag_half_gauss_der_wf},
