...
with program() as DC_filter:
    ...
    measure('readoutOp', 'qe1', data_stream, integration.moving_window("cosine_weight", data, chunk_size, 1))
...
with program() as IF_filter:
    ...
    measure('readoutOp', 'qe1', data_stream, demod.moving_window("sine_weight", data, chunk_size, 1))
...
job = QM1.simulate(DC_filter,
                   SimulationConfig(7500, simulation_interface=LoopbackInterface([("con1", 1, "con1", 1)], latency=184)))
